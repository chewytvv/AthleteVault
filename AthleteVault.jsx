...
const SCHOOLS=[
  // ── SEC ──
  {id:1,name:"University of Texas",nick:"Longhorns",div:"NCAA D1",conf:"SEC",loc:"Austin, TX",country:"United States",state:"Texas",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Tennis","Golf"],scholarships:true,schNote:"Full scholarships. Highly competitive.",tuition:"$11,698 / $41,070",accept:"31%",site:"utexas.edu",logo:"🤘",type:"Public",openings:{Football:"WR, DB, OL",Basketball:"PG, SG",Track:"Sprinters, Jumpers"},enrollment:51000,desc:"The University of Texas Longhorns compete at the highest level of college athletics in the SEC. With over $250M in NIL deals flowing through the program and elite facilities, UT is a top destination for athletes across every sport."},
  {id:2,name:"University of Alabama",nick:"Crimson Tide",div:"NCAA D1",conf:"SEC",loc:"Tuscaloosa, AL",country:"United States",state:"Alabama",sports:["Football","Basketball","Baseball","Track","Soccer","Gymnastics"],scholarships:true,schNote:"Full scholarships. Multiple national titles.",tuition:"$10,780 / $30,250",accept:"80%",site:"ua.edu",logo:"🐘",type:"Public",openings:{Football:"DB, LB, WR",Basketball:"Forward, Center"},enrollment:38000,desc:"Alabama has produced more NFL first-round picks than any program in the modern era and won 6 national championships since 2009. Bryant-Denny Stadium holds 100,000+ fans and the NIL ecosystem is one of the best in the country."},
  {id:3,name:"Ohio State University",nick:"Buckeyes",div:"NCAA D1",conf:"Big Ten",loc:"Columbus, OH",country:"United States",state:"Ohio",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Wrestling"],scholarships:true,schNote:"Full scholarships. Elite across all sports.",tuition:"$11,918 / $33,502",accept:"54%",site:"osu.edu",logo:"🌰",type:"Public",openings:{Football:"All positions",Basketball:"SG, SF",Track:"All events"},enrollment:61000,desc:"Ohio State is a perennial powerhouse across football, basketball, track and field, and wrestling. The Buckeyes have the largest athletic budget in the country and produce pro athletes at every level."},
  {id:4,name:"LSU",nick:"Tigers",div:"NCAA D1",conf:"SEC",loc:"Baton Rouge, LA",country:"United States",state:"Louisiana",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Gymnastics"],scholarships:true,schNote:"Full scholarships.",tuition:"$8,038 / $26,916",accept:"70%",site:"lsu.edu",logo:"🐯",type:"Public",openings:{Football:"WR, DB",Baseball:"Pitchers",Track:"All sprints"},enrollment:37000,desc:"LSU is known as the cradle of NFL talent — Tiger Stadium (Death Valley) is one of the loudest venues in sports. The track program is historically elite and the baseball team is a perennial College World Series contender."},
  {id:5,name:"University of Florida",nick:"Gators",div:"NCAA D1",conf:"SEC",loc:"Gainesville, FL",country:"United States",state:"Florida",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Tennis"],scholarships:true,schNote:"Full scholarships. Strong academics.",tuition:"$6,380 / $28,658",accept:"31%",site:"ufl.edu",logo:"🐊",type:"Public",openings:{Football:"QB, WR",Basketball:"All positions"},enrollment:57000,desc:"Florida is one of only two programs to win national championships in football and basketball in the same year. The Gator recruiting pipeline stretches across Florida's deep talent base with elite facilities across every sport."},
  {id:6,name:"University of Georgia",nick:"Bulldogs",div:"NCAA D1",conf:"SEC",loc:"Athens, GA",country:"United States",state:"Georgia",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Tennis","Golf"],scholarships:true,schNote:"Full scholarships.",tuition:"$9,790 / $29,820",accept:"45%",site:"uga.edu",logo:"🐕",type:"Public",openings:{Football:"WR, DB, TE",Tennis:"All",Golf:"All"},enrollment:40000,desc:"Georgia won back-to-back national championships in 2021-22 and has become the gold standard for SEC recruiting. Athens is one of the best college towns in America with a thriving NIL market."},
  {id:7,name:"Texas A&M",nick:"Aggies",div:"NCAA D1",conf:"SEC",loc:"College Station, TX",country:"United States",state:"Texas",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Tennis"],scholarships:true,schNote:"Full scholarships.",tuition:"$12,243 / $38,000",accept:"63%",site:"tamu.edu",logo:"🐾",type:"Public",openings:{Track:"All events",Football:"OL, DL",Baseball:"All positions"},enrollment:74000,desc:"Texas A&M is the largest university by enrollment in the US and its Aggie fanbase is legendary. The 12th Man tradition, massive NIL fund, and state-of-the-art facilities make it a premier destination."},
  {id:21,name:"Auburn University",nick:"Tigers",div:"NCAA D1",conf:"SEC",loc:"Auburn, AL",country:"United States",state:"Alabama",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Tennis","Golf","Gymnastics"],scholarships:true,schNote:"Full scholarships.",tuition:"$11,846 / $32,444",accept:"80%",site:"auburn.edu",logo:"🐯",type:"Public",openings:{Football:"WR, DB, LB",Track:"Sprinters, throwers"},enrollment:31000,desc:"Auburn's War Eagle rivalry with Alabama is one of the most intense in all of sports. The Plains are home to elite football and a rising track & field program with recent Olympic representation."},
  {id:22,name:"University of Tennessee",nick:"Volunteers",div:"NCAA D1",conf:"SEC",loc:"Knoxville, TN",country:"United States",state:"Tennessee",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Tennis","Golf"],scholarships:true,schNote:"Full scholarships.",tuition:"$13,244 / $31,840",accept:"72%",site:"utk.edu",logo:"🟠",type:"Public",openings:{Football:"DB, WR, OL",Basketball:"Guards",Track:"All sprints"},enrollment:33000,desc:"Tennessee's football program has been revitalized with elite recruiting and NIL investment. Neyland Stadium holds 102,000 fans making it one of the largest venues in sports, and the SEC East rivalry games are must-see events."},
  {id:23,name:"University of Mississippi",nick:"Rebels",div:"NCAA D1",conf:"SEC",loc:"Oxford, MS",country:"United States",state:"Mississippi",sports:["Football","Basketball","Baseball","Track","Soccer","Tennis"],scholarships:true,schNote:"Full scholarships.",tuition:"$9,072 / $26,428",accept:"97%",site:"olemiss.edu",logo:"🅾️",type:"Public",openings:{Football:"Skill positions",Baseball:"All"},enrollment:22000,desc:"Ole Miss has emerged as an NIL powerhouse with Grove Bowl atmosphere second to none in college football. The Oxford culture and upgraded facilities have made the Rebels a legitimate SEC contender."},
  {id:24,name:"Mississippi State University",nick:"Bulldogs",div:"NCAA D1",conf:"SEC",loc:"Starkville, MS",country:"United States",state:"Mississippi",sports:["Football","Basketball","Baseball","Track","Soccer","Tennis","Golf"],scholarships:true,schNote:"Full scholarships.",tuition:"$9,006 / $25,706",accept:"69%",site:"msstate.edu",logo:"🐕",type:"Public",openings:{Football:"OL, DL",Baseball:"Pitchers, catchers"},enrollment:22000,desc:"Mississippi State's baseball program is consistently among the nation's best with Dudy Noble Field offering one of the premier ballpark atmospheres in college baseball. Football competes hard in the SEC West."},
  {id:25,name:"University of Arkansas",nick:"Razorbacks",div:"NCAA D1",conf:"SEC",loc:"Fayetteville, AR",country:"United States",state:"Arkansas",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Tennis","Golf","Gymnastics"],scholarships:true,schNote:"Full scholarships.",tuition:"$9,564 / $26,628",accept:"79%",site:"uark.edu",logo:"🐗",type:"Public",openings:{Track:"All events",Football:"DB, WR",Baseball:"All"},enrollment:28000,desc:"Arkansas track & field is a dynasty — the Razorbacks have won more national titles in cross country and indoor/outdoor track than any program in history. Football is resurgent with elite SEC West competition."},
  {id:26,name:"University of South Carolina",nick:"Gamecocks",div:"NCAA D1",conf:"SEC",loc:"Columbia, SC",country:"United States",state:"South Carolina",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Tennis","Golf"],scholarships:true,schNote:"Full scholarships.",tuition:"$12,288 / $32,572",accept:"67%",site:"sc.edu",logo:"🐓",type:"Public",openings:{Football:"WR, DB",Basketball:"Guards, forwards"},enrollment:35000,desc:"South Carolina's women's basketball program under Dawn Staley is the gold standard — back-to-back national champions. The football program plays in Williams-Brice Stadium to 77,000 fans with strong SEC competition."},
  {id:27,name:"University of Missouri",nick:"Tigers",div:"NCAA D1",conf:"SEC",loc:"Columbia, MO",country:"United States",state:"Missouri",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Tennis","Golf","Wrestling","Gymnastics"],scholarships:true,schNote:"Full scholarships.",tuition:"$11,664 / $28,644",accept:"77%",site:"missouri.edu",logo:"🐯",type:"Public",openings:{Football:"All",Track:"All events"},enrollment:30000,desc:"Mizzou offers a full college athletics experience in the SEC with strong wrestling, gymnastics and track programs alongside competitive football and basketball. Columbia offers affordable cost of living."},
  {id:28,name:"Vanderbilt University",nick:"Commodores",div:"NCAA D1",conf:"SEC",loc:"Nashville, TN",country:"United States",state:"Tennessee",sports:["Football","Basketball","Baseball","Track","Soccer","Tennis","Golf","Lacrosse"],scholarships:true,schNote:"Full scholarships. Best academics in SEC.",tuition:"$60,348",accept:"7%",site:"vanderbilt.edu",logo:"⭐",type:"Private",openings:{Baseball:"Pitchers",Tennis:"All"},enrollment:13000,desc:"Vanderbilt is the only elite private research university in the SEC — a degree here opens doors no other SEC school can match. The baseball program under Tim Corbin is consistently the best in the country."},
  {id:29,name:"University of Kentucky",nick:"Wildcats",div:"NCAA D1",conf:"SEC",loc:"Lexington, KY",country:"United States",state:"Kentucky",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Tennis","Golf","Volleyball"],scholarships:true,schNote:"Full scholarships.",tuition:"$12,591 / $30,951",accept:"96%",site:"uky.edu",logo:"🐱",type:"Public",openings:{Basketball:"All positions",Football:"DB, LB"},enrollment:31000,desc:"Kentucky basketball is a religion — Rupp Arena is one of the loudest venues in college hoops and the Wildcats have produced more NBA first-round picks than any program. Baseball and football are also competitive in the SEC."},
  {id:30,name:"University of Oklahoma",nick:"Sooners",div:"NCAA D1",conf:"SEC",loc:"Norman, OK",country:"United States",state:"Oklahoma",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Tennis","Golf","Wrestling","Gymnastics","Softball"],scholarships:true,schNote:"Full scholarships.",tuition:"$11,538 / $27,708",accept:"72%",site:"ou.edu",logo:"🅾️",type:"Public",openings:{Football:"All positions",Wrestling:"All",Gymnastics:"All"},enrollment:29000,desc:"Oklahoma is a football dynasty with 8 national championships and 56 conference titles. The Sooners transitioned to the SEC in 2024 bringing one of the most passionate fanbases in sports to a new level of competition."},
  // ── Big Ten ──
  {id:31,name:"University of Michigan",nick:"Wolverines",div:"NCAA D1",conf:"Big Ten",loc:"Ann Arbor, MI",country:"United States",state:"Michigan",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Hockey","Tennis","Golf","Wrestling"],scholarships:true,schNote:"Full scholarships.",tuition:"$16,736 / $55,334",accept:"17%",site:"umich.edu",logo:"🐺",type:"Public",openings:{Football:"WR, DB, OL",Basketball:"Guards"},enrollment:47000,desc:"Michigan is one of the most storied programs in college football with 973 wins — the most in FBS history. The Big House holds 107,000 fans and Michigan Men have gone on to become some of the biggest names in sports and business."},
  {id:32,name:"Penn State University",nick:"Nittany Lions",div:"NCAA D1",conf:"Big Ten",loc:"State College, PA",country:"United States",state:"Pennsylvania",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Wrestling","Volleyball","Tennis"],scholarships:true,schNote:"Full scholarships.",tuition:"$18,454 / $38,672",accept:"56%",site:"psu.edu",logo:"🦁",type:"Public",openings:{Football:"DB, LB, TE",Wrestling:"All weight classes"},enrollment:46000,desc:"Penn State's football atmosphere in Beaver Stadium — 106,000 fans in white for White Out games — is one of the most intimidating in sports. The wrestling program is historically elite with dozens of national champions."},
  {id:33,name:"Michigan State University",nick:"Spartans",div:"NCAA D1",conf:"Big Ten",loc:"East Lansing, MI",country:"United States",state:"Michigan",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Hockey","Tennis","Golf","Wrestling"],scholarships:true,schNote:"Full scholarships.",tuition:"$15,242 / $41,956",accept:"88%",site:"msu.edu",logo:"💚",type:"Public",openings:{Football:"All",Basketball:"All positions"},enrollment:49000,desc:"Michigan State has a proud tradition in football and basketball — Spartan football under coaching legends is a Big Ten staple. The rivalry with Michigan is one of the best in college sports."},
  {id:34,name:"University of Iowa",nick:"Hawkeyes",div:"NCAA D1",conf:"Big Ten",loc:"Iowa City, IA",country:"United States",state:"Iowa",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Wrestling","Tennis","Golf"],scholarships:true,schNote:"Full scholarships.",tuition:"$9,946 / $31,980",accept:"83%",site:"uiowa.edu",logo:"🐦",type:"Public",openings:{Wrestling:"All",Football:"OL, DL",Track:"Throwers"},enrollment:31000,desc:"Iowa wrestling is one of the most decorated programs in collegiate history with 24 national team championships. The football program is a consistent Big Ten contender with NFL-caliber player development."},
  {id:35,name:"University of Wisconsin",nick:"Badgers",div:"NCAA D1",conf:"Big Ten",loc:"Madison, WI",country:"United States",state:"Wisconsin",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Hockey","Tennis","Golf","Wrestling","Volleyball","Rowing"],scholarships:true,schNote:"Full scholarships.",tuition:"$10,723 / $38,079",accept:"57%",site:"wisc.edu",logo:"🦡",type:"Public",openings:{Football:"OL, LB",Track:"Distance runners"},enrollment:45000,desc:"Wisconsin football is an offensive lineman factory — the Badgers have produced more NFL offensive linemen per roster than almost any program. Madison is a top-10 college town and the rowing program is elite."},
  {id:36,name:"University of Minnesota",nick:"Golden Gophers",div:"NCAA D1",conf:"Big Ten",loc:"Minneapolis, MN",country:"United States",state:"Minnesota",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Hockey","Tennis","Golf","Wrestling","Gymnastics"],scholarships:true,schNote:"Full scholarships.",tuition:"$14,034 / $31,380",accept:"73%",site:"umn.edu",logo:"🐿️",type:"Public",openings:{Football:"All",Hockey:"All positions",Wrestling:"All"},enrollment:52000,desc:"Minnesota's hockey program competes at the highest level with multiple national championships. Minneapolis offers big-city professional sports culture and strong career networks for student athletes."},
  {id:37,name:"University of Nebraska",nick:"Cornhuskers",div:"NCAA D1",conf:"Big Ten",loc:"Lincoln, NE",country:"United States",state:"Nebraska",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Tennis","Golf","Wrestling","Volleyball","Gymnastics"],scholarships:true,schNote:"Full scholarships.",tuition:"$9,742 / $27,872",accept:"79%",site:"unl.edu",logo:"🌽",type:"Public",openings:{Football:"All",Volleyball:"All",Wrestling:"All"},enrollment:25000,desc:"Nebraska sold out 400+ consecutive home football games — that fanbase loyalty is unmatched in college sports. The volleyball program is consistently among the nation's best and the wrestling program is a Big Ten contender."},
  {id:38,name:"University of Maryland",nick:"Terrapins",div:"NCAA D1",conf:"Big Ten",loc:"College Park, MD",country:"United States",state:"Maryland",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Tennis","Golf","Wrestling","Lacrosse","Field Hockey"],scholarships:true,schNote:"Full scholarships.",tuition:"$10,779 / $38,035",accept:"44%",site:"umd.edu",logo:"🐢",type:"Public",openings:{Football:"Skill positions",Lacrosse:"All"},enrollment:40000,desc:"Maryland is a powerhouse in lacrosse and field hockey with multiple national championships. The Big Ten membership brings elite competition and the proximity to DC, Baltimore, and Philadelphia creates massive recruiting advantages."},
  {id:39,name:"Rutgers University",nick:"Scarlet Knights",div:"NCAA D1",conf:"Big Ten",loc:"New Brunswick, NJ",country:"United States",state:"New Jersey",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Tennis","Golf","Wrestling","Gymnastics"],scholarships:true,schNote:"Full scholarships.",tuition:"$15,507 / $33,026",accept:"68%",site:"rutgers.edu",logo:"⚔️",type:"Public",openings:{Football:"All",Wrestling:"All"},enrollment:50000,desc:"Rutgers is the birthplace of college football and brings the NYC/NJ recruiting market to the Big Ten. The wrestling program competes for national championships and proximity to New York City provides unmatched NIL opportunities."},
  {id:40,name:"Indiana University",nick:"Hoosiers",div:"NCAA D1",conf:"Big Ten",loc:"Bloomington, IN",country:"United States",state:"Indiana",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Tennis","Golf","Wrestling"],scholarships:true,schNote:"Full scholarships.",tuition:"$10,682 / $38,080",accept:"78%",site:"indiana.edu",logo:"🏀",type:"Public",openings:{Basketball:"All",Football:"WR, DB",Soccer:"All positions"},enrollment:47000,desc:"Indiana basketball has a legendary history with 5 national championships. The soccer program regularly reaches the NCAA tournament and the football program is trending upward in the Big Ten."},
  {id:41,name:"University of Illinois",nick:"Fighting Illini",div:"NCAA D1",conf:"Big Ten",loc:"Champaign, IL",country:"United States",state:"Illinois",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Tennis","Golf","Wrestling","Gymnastics","Volleyball"],scholarships:true,schNote:"Full scholarships.",tuition:"$15,054 / $32,508",accept:"62%",site:"illinois.edu",logo:"🔶",type:"Public",openings:{Football:"All",Track:"All events",Wrestling:"All"},enrollment:56000,desc:"Illinois competes in arguably the best athletic conference in the world. The Chicago market recruiting pipeline, upgraded facilities, and Big Ten exposure make Illinois a strong platform for professional aspirations."},
  {id:42,name:"Purdue University",nick:"Boilermakers",div:"NCAA D1",conf:"Big Ten",loc:"West Lafayette, IN",country:"United States",state:"Indiana",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Tennis","Golf","Wrestling"],scholarships:true,schNote:"Full scholarships.",tuition:"$9,992 / $28,794",accept:"53%",site:"purdue.edu",logo:"🚂",type:"Public",openings:{Football:"OL, QB",Basketball:"Guards"},enrollment:47000,desc:"Purdue basketball has produced NBA talent consistently and the program makes deep NCAA tournament runs. The engineering school is among the best in the world — a Purdue degree opens doors in every industry."},
  {id:43,name:"Northwestern University",nick:"Wildcats",div:"NCAA D1",conf:"Big Ten",loc:"Evanston, IL",country:"United States",state:"Illinois",sports:["Football","Basketball","Baseball","Track","Soccer","Tennis","Golf","Wrestling","Lacrosse","Volleyball","Field Hockey"],scholarships:true,schNote:"Full scholarships. Best academics in Big Ten.",tuition:"$62,391",accept:"7%",site:"northwestern.edu",logo:"🟣",type:"Private",openings:{Football:"All",Lacrosse:"All"},enrollment:23000,desc:"Northwestern is the only private research university in the Big Ten — an Ivy-level education with Power 4 athletics. The football program competes at the highest level while players graduate with one of the most prestigious degrees in America."},
  {id:44,name:"UCLA",nick:"Bruins",div:"NCAA D1",conf:"Big Ten",loc:"Los Angeles, CA",country:"United States",state:"California",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Tennis","Golf","Gymnastics","Volleyball","Water Polo"],scholarships:true,schNote:"Full scholarships.",tuition:"$13,258 / $43,680",accept:"9%",site:"ucla.edu",logo:"🐻",type:"Public",openings:{Football:"All",Track:"All events",Basketball:"All positions"},enrollment:46000,desc:"UCLA has won more NCAA championships than any school in history (119+). Los Angeles is the NIL capital of the world — athletes here have unmatched access to brands, media, and entertainment industry connections."},
  {id:45,name:"USC",nick:"Trojans",div:"NCAA D1",conf:"Big Ten",loc:"Los Angeles, CA",country:"United States",state:"California",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Tennis","Golf","Volleyball","Water Polo"],scholarships:true,schNote:"Full scholarships.",tuition:"$68,237",accept:"11%",site:"usc.edu",logo:"⚔️",type:"Private",openings:{Football:"Skill positions",Track:"Sprinters, throwers"},enrollment:47000,desc:"USC football is one of the most storied programs in history — the Trojans have produced more NFL draft picks than almost any school. The Hollywood/entertainment network and LA NIL market make USC an elite platform for athlete brands."},
  {id:46,name:"University of Washington",nick:"Huskies",div:"NCAA D1",conf:"Big Ten",loc:"Seattle, WA",country:"United States",state:"Washington",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Tennis","Golf","Volleyball","Rowing"],scholarships:true,schNote:"Full scholarships.",tuition:"$12,076 / $40,086",accept:"49%",site:"washington.edu",logo:"🐺",type:"Public",openings:{Football:"All",Rowing:"All"},enrollment:47000,desc:"Washington football reached the national championship game in 2024 cementing the Huskies as a national power. Seattle's tech industry creates strong NIL and career opportunities and the rowing program is elite."},
  {id:9,name:"University of Oregon",nick:"Ducks",div:"NCAA D1",conf:"Big Ten",loc:"Eugene, OR",country:"United States",state:"Oregon",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Tennis","Golf","Wrestling","Volleyball"],scholarships:true,schNote:"Full scholarships. Nike-backed elite facilities.",tuition:"$11,574 / $37,626",accept:"84%",site:"uoregon.edu",logo:"🦆",type:"Public",openings:{Football:"All positions",Track:"All events",Basketball:"Guards"},enrollment:22000,desc:"Oregon is the Nike flagship — Phil Knight's alma mater transformed the program into a national brand powerhouse with the most iconic uniforms in college sports. The Ducks football and track programs consistently produce NFL and Olympic talent and Autzen Stadium is one of the loudest venues in college football."},
  // ── ACC ──
  {id:8,name:"Notre Dame",nick:"Fighting Irish",div:"NCAA D1",conf:"ACC",loc:"Notre Dame, IN",country:"United States",state:"Indiana",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Tennis","Lacrosse"],scholarships:true,schNote:"Full scholarships. Elite academics.",tuition:"$60,301",accept:"13%",site:"nd.edu",logo:"☘️",type:"Private",openings:{Football:"DB, LB",Soccer:"Forward, MF"},enrollment:12000,desc:"Notre Dame is college football's most storied independent-turned-ACC program — the Fighting Irish brand is global. A Notre Dame degree is among the most respected in America and the football program consistently produces NFL talent."},
  {id:47,name:"Clemson University",nick:"Tigers",div:"NCAA D1",conf:"ACC",loc:"Clemson, SC",country:"United States",state:"South Carolina",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Tennis","Golf","Rowing"],scholarships:true,schNote:"Full scholarships.",tuition:"$15,558 / $40,400",accept:"47%",site:"clemson.edu",logo:"🐯",type:"Public",openings:{Football:"WR, DB, OL",Track:"All"},enrollment:27000,desc:"Clemson won 2 national championships in 3 years (2016, 2018) under Dabo Swinney and remains an elite recruiting destination. The WestZone facility is among the best in college football and the program culture is nationally respected."},
  {id:48,name:"Florida State University",nick:"Seminoles",div:"NCAA D1",conf:"ACC",loc:"Tallahassee, FL",country:"United States",state:"Florida",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Tennis","Golf","Softball","Volleyball"],scholarships:true,schNote:"Full scholarships.",tuition:"$5,656 / $21,683",accept:"37%",site:"fsu.edu",logo:"🪶",type:"Public",openings:{Football:"All positions",Baseball:"All"},enrollment:44000,desc:"Florida State is a football dynasty with 3 national championships and produced legends like Deion Sanders, Warrick Dunn, and Jameis Winston. The Tallahassee recruiting pipeline taps into Florida's elite athlete talent base."},
  {id:49,name:"University of Miami",nick:"Hurricanes",div:"NCAA D1",conf:"ACC",loc:"Coral Gables, FL",country:"United States",state:"Florida",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Tennis","Golf","Volleyball"],scholarships:true,schNote:"Full scholarships.",tuition:"$60,050",accept:"20%",site:"miami.edu",logo:"🌀",type:"Private",openings:{Football:"All skill positions",Baseball:"All"},enrollment:17000,desc:"Miami is The U — a football brand that transcends college sports. South Florida's recruiting base combined with Miami's NIL market and international connections make this one of the most exciting programs to be part of in 2025+."},
  {id:50,name:"Duke University",nick:"Blue Devils",div:"NCAA D1",conf:"ACC",loc:"Durham, NC",country:"United States",state:"North Carolina",sports:["Basketball","Football","Baseball","Track","Soccer","Tennis","Golf","Lacrosse","Volleyball"],scholarships:true,schNote:"Full scholarships. Elite academics.",tuition:"$63,054",accept:"7%",site:"duke.edu",logo:"😈",type:"Private",openings:{Basketball:"All positions",Soccer:"All",Lacrosse:"All"},enrollment:16000,desc:"Duke basketball is the pinnacle of college hoops — Cameron Indoor Stadium is the most electric atmosphere in sports and Coach K's legacy is unmatched. A Duke degree from one of the top-5 universities in the world is a career-changer."},
  {id:51,name:"UNC Chapel Hill",nick:"Tar Heels",div:"NCAA D1",conf:"ACC",loc:"Chapel Hill, NC",country:"United States",state:"North Carolina",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Tennis","Golf","Lacrosse","Field Hockey","Volleyball"],scholarships:true,schNote:"Full scholarships.",tuition:"$7,020 / $36,692",accept:"20%",site:"unc.edu",logo:"🐏",type:"Public",openings:{Basketball:"All",Soccer:"All positions",Lacrosse:"All"},enrollment:30000,desc:"UNC is the most successful college basketball program in history alongside Duke and Kentucky. The women's soccer program is a dynasty and the ACC environment creates elite competition across every sport."},
  {id:52,name:"NC State University",nick:"Wolfpack",div:"NCAA D1",conf:"ACC",loc:"Raleigh, NC",country:"United States",state:"North Carolina",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Tennis","Golf","Wrestling","Volleyball"],scholarships:true,schNote:"Full scholarships.",tuition:"$9,054 / $29,136",accept:"45%",site:"ncsu.edu",logo:"🐺",type:"Public",openings:{Football:"All",Wrestling:"All"},enrollment:36000,desc:"NC State made one of the greatest NCAA tournament runs in history in 2024 reaching the Elite Eight. The Research Triangle location means unmatched internship, career, and NIL opportunities in the tech corridor."},
  {id:53,name:"Georgia Tech",nick:"Yellow Jackets",div:"NCAA D1",conf:"ACC",loc:"Atlanta, GA",country:"United States",state:"Georgia",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Tennis","Golf","Volleyball"],scholarships:true,schNote:"Full scholarships. Strong STEM focus.",tuition:"$12,682 / $33,964",accept:"21%",site:"gatech.edu",logo:"🐝",type:"Public",openings:{Football:"All",Track:"All events"},enrollment:22000,desc:"Georgia Tech's engineering degree is globally respected and athletes graduate with one of the most valuable degrees in America. Atlanta provides massive NIL market access and the ACC schedule provides elite competition."},
  {id:54,name:"University of Virginia",nick:"Cavaliers",div:"NCAA D1",conf:"ACC",loc:"Charlottesville, VA",country:"United States",state:"Virginia",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Tennis","Golf","Lacrosse","Wrestling"],scholarships:true,schNote:"Full scholarships. Strong academics.",tuition:"$17,970 / $52,218",accept:"21%",site:"virginia.edu",logo:"🔶",type:"Public",openings:{Basketball:"All",Soccer:"All",Lacrosse:"All"},enrollment:25000,desc:"Virginia basketball won the 2019 national championship with the most patient and cerebral style in college sports. The lacrosse program is a dynasty and UVA's academic reputation is among the best of any public university."},
  {id:55,name:"Virginia Tech",nick:"Hokies",div:"NCAA D1",conf:"ACC",loc:"Blacksburg, VA",country:"United States",state:"Virginia",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Tennis","Golf","Wrestling","Volleyball"],scholarships:true,schNote:"Full scholarships.",tuition:"$13,872 / $31,868",accept:"66%",site:"vt.edu",logo:"🦃",type:"Public",openings:{Football:"All",Wrestling:"All"},enrollment:37000,desc:"Virginia Tech football with Lane Stadium's Enter Sandman entrance is one of the most electric moments in all of college sports. The Hokies compete hard in the ACC and the engineering school is world-class."},
  {id:56,name:"Syracuse University",nick:"Orange",div:"NCAA D1",conf:"ACC",loc:"Syracuse, NY",country:"United States",state:"New York",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Tennis","Lacrosse","Field Hockey","Rowing"],scholarships:true,schNote:"Full scholarships.",tuition:"$60,578",accept:"46%",site:"syracuse.edu",logo:"🟠",type:"Private",openings:{Football:"All",Basketball:"Guards",Lacrosse:"All"},enrollment:22000,desc:"Syracuse lacrosse is the gold standard — more national championships than any other program. The basketball program regularly fills the Carrier Dome (now JMA Wireless Dome) with 30,000 fans and produces NBA talent."},
  {id:57,name:"University of Louisville",nick:"Cardinals",div:"NCAA D1",conf:"ACC",loc:"Louisville, KY",country:"United States",state:"Kentucky",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Tennis","Golf","Volleyball","Field Hockey"],scholarships:true,schNote:"Full scholarships.",tuition:"$11,726 / $28,272",accept:"66%",site:"louisville.edu",logo:"🐦",type:"Public",openings:{Football:"All",Baseball:"All",Basketball:"Guards"},enrollment:23000,desc:"Louisville basketball has produced NBA talent consistently and the baseball program is a perennial ACC contender. Louisville sits between Cincinnati, Lexington, and Indianapolis in a strong recruiting corridor."},
  {id:58,name:"University of Pittsburgh",nick:"Panthers",div:"NCAA D1",conf:"ACC",loc:"Pittsburgh, PA",country:"United States",state:"Pennsylvania",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Tennis","Golf","Wrestling","Volleyball"],scholarships:true,schNote:"Full scholarships.",tuition:"$19,868 / $34,832",accept:"57%",site:"pitt.edu",logo:"🐾",type:"Public",openings:{Football:"All",Wrestling:"All"},enrollment:34000,desc:"Pitt football has a legendary history — Tony Dorsett, Dan Marino, and Larry Fitzgerald all wore the blue and gold. The wrestling program is a Big East/ACC powerhouse and Pittsburgh is a rising city for career opportunities."},
  {id:59,name:"Stanford University",nick:"Cardinal",div:"NCAA D1",conf:"ACC",loc:"Stanford, CA",country:"United States",state:"California",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Tennis","Golf","Volleyball","Wrestling","Water Polo","Lacrosse"],scholarships:true,schNote:"Need-based + athletic scholarships.",tuition:"$61,731",accept:"4%",site:"stanford.edu",logo:"🌲",type:"Private",openings:{Track:"All events",Swimming:"All",Tennis:"All"},enrollment:17000,desc:"Stanford is the greatest collegiate athletics program in American history — 130+ national championships across all sports. The Silicon Valley location, academic prestige, and athletic excellence create an unmatched combination for elite athletes."},
  {id:60,name:"Boston College",nick:"Eagles",div:"NCAA D1",conf:"ACC",loc:"Chestnut Hill, MA",country:"United States",state:"Massachusetts",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Tennis","Golf","Hockey","Lacrosse","Volleyball"],scholarships:true,schNote:"Full scholarships.",tuition:"$64,000",accept:"20%",site:"bc.edu",logo:"🦅",type:"Private",openings:{Football:"All",Hockey:"All positions"},enrollment:14000,desc:"Boston College is the only ACC school in the Northeast — the Eagle Ice Hockey program is an annual national title contender. The Boston location provides Ivy-level career networks and the city's sports culture is unmatched."},
  {id:61,name:"Wake Forest University",nick:"Demon Deacons",div:"NCAA D1",conf:"ACC",loc:"Winston-Salem, NC",country:"United States",state:"North Carolina",sports:["Football","Basketball","Baseball","Track","Soccer","Tennis","Golf","Volleyball"],scholarships:true,schNote:"Full scholarships.",tuition:"$62,416",accept:"25%",site:"wfu.edu",logo:"⚜️",type:"Private",openings:{Baseball:"All",Golf:"All"},enrollment:8000,desc:"Wake Forest is the smallest Power 4 school and produces NFL quarterbacks at a remarkable rate. The small campus culture creates tight-knit team environments and the ACC schedule provides elite competition."},
  // ── Big 12 ──
  {id:62,name:"Oklahoma State University",nick:"Cowboys",div:"NCAA D1",conf:"Big 12",loc:"Stillwater, OK",country:"United States",state:"Oklahoma",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Tennis","Golf","Wrestling","Gymnastics"],scholarships:true,schNote:"Full scholarships.",tuition:"$9,516 / $25,448",accept:"70%",site:"okstate.edu",logo:"🤠",type:"Public",openings:{Football:"All",Wrestling:"All",Golf:"All"},enrollment:25000,desc:"Oklahoma State wrestling is one of the most decorated programs in history. The football program plays in Boone Pickens Stadium with elite facilities funded by T. Boone Pickens' historic $165M donation — largest in college sports history."},
  {id:63,name:"University of Kansas",nick:"Jayhawks",div:"NCAA D1",conf:"Big 12",loc:"Lawrence, KS",country:"United States",state:"Kansas",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Tennis","Golf","Volleyball"],scholarships:true,schNote:"Full scholarships.",tuition:"$10,092 / $26,800",accept:"93%",site:"ku.edu",logo:"🐦",type:"Public",openings:{Basketball:"All",Football:"All"},enrollment:27000,desc:"Kansas basketball is a religion — Allen Fieldhouse is the loudest arena in college hoops and the Jayhawks have won more conference titles than any program. The football program has been rebuilt with strong NIL investment."},
  {id:64,name:"Kansas State University",nick:"Wildcats",div:"NCAA D1",conf:"Big 12",loc:"Manhattan, KS",country:"United States",state:"Kansas",sports:["Football","Basketball","Baseball","Track","Soccer","Tennis","Golf","Wrestling","Volleyball"],scholarships:true,schNote:"Full scholarships.",tuition:"$9,592 / $25,680",accept:"94%",site:"kstate.edu",logo:"😼",type:"Public",openings:{Football:"All",Wrestling:"All"},enrollment:22000,desc:"Kansas State football's Bill Snyder turned a historically bad program into a Big 12 contender — one of the greatest turnarounds in sports history. The wrestling program is competitive and Manhattan offers a strong Big 12 community."},
  {id:65,name:"Iowa State University",nick:"Cyclones",div:"NCAA D1",conf:"Big 12",loc:"Ames, IA",country:"United States",state:"Iowa",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Tennis","Golf","Wrestling","Volleyball"],scholarships:true,schNote:"Full scholarships.",tuition:"$9,146 / $24,508",accept:"91%",site:"iastate.edu",logo:"🌪️",type:"Public",openings:{Football:"All",Wrestling:"All",Basketball:"All"},enrollment:29000,desc:"Iowa State is rising — the Cyclones upset the top teams in the Big 12 year after year. The wrestling program competes nationally and the passionate Cyclone fanbase creates a special home atmosphere."},
  {id:66,name:"TCU",nick:"Horned Frogs",div:"NCAA D1",conf:"Big 12",loc:"Fort Worth, TX",country:"United States",state:"Texas",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Tennis","Golf","Volleyball"],scholarships:true,schNote:"Full scholarships.",tuition:"$57,100",accept:"40%",site:"tcu.edu",logo:"🦎",type:"Private",openings:{Football:"All",Baseball:"All"},enrollment:11000,desc:"TCU played in the 2022 national championship game as a Cinderella story — the Fort Worth culture and DFW market access provide elite NIL opportunities. The program has produced NFL stars including Trevone Boykin and Deante' Gray."},
  {id:67,name:"Baylor University",nick:"Bears",div:"NCAA D1",conf:"Big 12",loc:"Waco, TX",country:"United States",state:"Texas",sports:["Football","Basketball","Baseball","Track","Soccer","Tennis","Golf","Volleyball","Equestrian","Rowing"],scholarships:true,schNote:"Full scholarships.",tuition:"$54,278",accept:"45%",site:"baylor.edu",logo:"🐻",type:"Private",openings:{Football:"All",Basketball:"All positions"},enrollment:20000,desc:"Baylor football won the 2021 national championship — an incredible turnaround story. The women's basketball program under Kim Mulkey was a dynasty and the Bears are a Big 12 power. The Christian values environment attracts family-oriented recruits."},
  {id:68,name:"West Virginia University",nick:"Mountaineers",div:"NCAA D1",conf:"Big 12",loc:"Morgantown, WV",country:"United States",state:"West Virginia",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Tennis","Golf","Wrestling","Gymnastics","Volleyball","Rowing"],scholarships:true,schNote:"Full scholarships.",tuition:"$9,144 / $26,568",accept:"80%",site:"wvu.edu",logo:"⛰️",type:"Public",openings:{Football:"All",Wrestling:"All",Gymnastics:"All"},enrollment:25000,desc:"West Virginia football in Morgantown with the Backyard Brawl rivalry is one of the most passionate atmospheres in sports. The wrestling and gymnastics programs are nationally competitive and the fanbase is legendarily devoted."},
  {id:69,name:"University of Cincinnati",nick:"Bearcats",div:"NCAA D1",conf:"Big 12",loc:"Cincinnati, OH",country:"United States",state:"Ohio",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Tennis","Volleyball"],scholarships:true,schNote:"Full scholarships.",tuition:"$12,824 / $28,386",accept:"73%",site:"uc.edu",logo:"🐻",type:"Public",openings:{Football:"All",Basketball:"All"},enrollment:47000,desc:"Cincinnati made the College Football Playoff as a Group of 5 team in 2021 before joining the Big 12. The Bearcats compete at the highest level and the Cincinnati market provides urban NIL opportunities."},
  {id:70,name:"BYU",nick:"Cougars",div:"NCAA D1",conf:"Big 12",loc:"Provo, UT",country:"United States",state:"Utah",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Tennis","Golf","Volleyball","Wrestling"],scholarships:true,schNote:"Full scholarships.",tuition:"$6,496",accept:"67%",site:"byu.edu",logo:"🦅",type:"Private",openings:{Football:"All",Volleyball:"All",Wrestling:"All"},enrollment:33000,desc:"BYU football has a unique recruiting network through the LDS Church's global reach. The program has produced NFL quarterbacks like Steve Young and Jim McMahon and the campus culture is tight-knit and values-driven."},
  {id:71,name:"University of Houston",nick:"Cougars",div:"NCAA D1",conf:"Big 12",loc:"Houston, TX",country:"United States",state:"Texas",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Tennis","Golf","Volleyball"],scholarships:true,schNote:"Full scholarships.",tuition:"$8,558 / $22,418",accept:"74%",site:"uh.edu",logo:"🐾",type:"Public",openings:{Football:"All",Basketball:"All positions",Track:"All"},enrollment:47000,desc:"Houston is in the country's 4th largest city with one of the largest NIL markets in America. The Cougars football program produced Elvin Hayes, Hakeem Olajuwon, and Andre Ware. H-Town has the energy and resources to compete nationally."},
  {id:72,name:"University of Central Florida",nick:"Knights",div:"NCAA D1",conf:"Big 12",loc:"Orlando, FL",country:"United States",state:"Florida",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Tennis","Golf","Volleyball"],scholarships:true,schNote:"Full scholarships.",tuition:"$6,368 / $22,467",accept:"44%",site:"ucf.edu",logo:"⚔️",type:"Public",openings:{Football:"All",Track:"All",Basketball:"All"},enrollment:71000,desc:"UCF is the largest university by enrollment in the US — massive alumni network and Orlando's tourism/entertainment industry create unique NIL opportunities. The football program went undefeated in 2017-18 and competes for Big 12 championships."},
  {id:73,name:"University of Arizona",nick:"Wildcats",div:"NCAA D1",conf:"Big 12",loc:"Tucson, AZ",country:"United States",state:"Arizona",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Tennis","Golf","Volleyball","Softball"],scholarships:true,schNote:"Full scholarships.",tuition:"$11,384 / $34,380",accept:"85%",site:"arizona.edu",logo:"🐱",type:"Public",openings:{Basketball:"All",Football:"All",Track:"All"},enrollment:46000,desc:"Arizona basketball is a program with a rich tradition — producing NBA stars like Michael Bibby, Richard Jefferson, and Andre Iguodala. Tucson's warm climate, outdoor culture and Big 12 competition make it an appealing destination."},
  {id:74,name:"Arizona State University",nick:"Sun Devils",div:"NCAA D1",conf:"Big 12",loc:"Tempe, AZ",country:"United States",state:"Arizona",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Tennis","Golf","Volleyball","Wrestling","Softball"],scholarships:true,schNote:"Full scholarships.",tuition:"$11,736 / $29,166",accept:"84%",site:"asu.edu",logo:"😈",type:"Public",openings:{Football:"All",Track:"All events",Wrestling:"All"},enrollment:80000,desc:"ASU is the largest public university in America and the Sun Belt's leading innovation engine. Tempe's weather, the Phoenix metro NIL market, and Big 12 competition create a winning environment for ambitious athletes."},
  {id:75,name:"University of Colorado",nick:"Buffaloes",div:"NCAA D1",conf:"Big 12",loc:"Boulder, CO",country:"United States",state:"Colorado",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Tennis","Golf","Volleyball","Wrestling","Skiing"],scholarships:true,schNote:"Full scholarships.",tuition:"$13,866 / $36,762",accept:"85%",site:"colorado.edu",logo:"🦬",type:"Public",openings:{Football:"All",Track:"All events"},enrollment:36000,desc:"Deion Sanders' arrival at Colorado created one of the biggest recruiting waves in college football history. Boulder's outdoor lifestyle, the Denver metro NIL market, and rising Big 12 program make this one of the most exciting destinations right now."},
  {id:76,name:"University of Utah",nick:"Utes",div:"NCAA D1",conf:"Big 12",loc:"Salt Lake City, UT",country:"United States",state:"Utah",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Tennis","Golf","Volleyball","Gymnastics","Skiing","Lacrosse"],scholarships:true,schNote:"Full scholarships.",tuition:"$9,766 / $31,062",accept:"78%",site:"utah.edu",logo:"🔴",type:"Public",openings:{Football:"All",Gymnastics:"All",Skiing:"All"},enrollment:35000,desc:"Utah has emerged as a Big 12 power after three Pac-12 Championship appearances. The gymnastics program is a national dynasty winning multiple titles and Salt Lake City's growth creates strong NIL opportunities."},
  // ── Other Major D1 ──
  {id:77,name:"Boise State University",nick:"Broncos",div:"NCAA D1",conf:"Mountain West",loc:"Boise, ID",country:"United States",state:"Idaho",sports:["Football","Basketball","Track","Soccer","Tennis","Golf","Gymnastics","Wrestling","Volleyball"],scholarships:true,schNote:"Full scholarships.",tuition:"$7,420 / $21,470",accept:"76%",site:"boisestate.edu",logo:"🐴",type:"Public",openings:{Football:"All",Wrestling:"All"},enrollment:26000,desc:"Boise State is famous for the blue turf and upset wins over Oklahoma in the 2007 Fiesta Bowl — one of the greatest games in college football history. The program consistently punches above its weight and produces NFL talent."},
  {id:78,name:"San Diego State",nick:"Aztecs",div:"NCAA D1",conf:"Mountain West",loc:"San Diego, CA",country:"United States",state:"California",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Tennis","Golf","Volleyball","Softball"],scholarships:true,schNote:"Full scholarships.",tuition:"$7,928 / $20,090",accept:"36%",site:"sdsu.edu",logo:"🗿",type:"Public",openings:{Football:"All",Basketball:"All positions"},enrollment:35000,desc:"San Diego State made the Final Four in 2023 and is a Mountain West basketball powerhouse. San Diego's weather, outdoor lifestyle, and proximity to the LA NIL market make it one of the most desirable locations in college sports."},
  {id:79,name:"University of Memphis",nick:"Tigers",div:"NCAA D1",conf:"AAC",loc:"Memphis, TN",country:"United States",state:"Tennessee",sports:["Football","Basketball","Baseball","Track","Soccer","Tennis","Golf","Volleyball"],scholarships:true,schNote:"Full scholarships.",tuition:"$9,048 / $19,464",accept:"88%",site:"memphis.edu",logo:"🐯",type:"Public",openings:{Football:"All",Basketball:"All positions",Track:"Sprinters"},enrollment:21000,desc:"Memphis basketball has produced NBA superstars including Anfernee Hardaway, Derrick Rose, and James Wiseman. The football program is an AAC contender and Memphis is a major music/culture city with growing NIL opportunities."},
  {id:80,name:"Tulane University",nick:"Green Wave",div:"NCAA D1",conf:"AAC",loc:"New Orleans, LA",country:"United States",state:"Louisiana",sports:["Football","Basketball","Baseball","Track","Soccer","Tennis","Golf","Volleyball","Rowing"],scholarships:true,schNote:"Full scholarships.",tuition:"$59,320",accept:"13%",site:"tulane.edu",logo:"🌊",type:"Private",openings:{Football:"All",Baseball:"All"},enrollment:14000,desc:"Tulane plays in New Orleans — the greatest food, music, and culture city in America. The football program has become an AAC contender and Tulane's academics rank among the nation's top-40 universities."},
  {id:81,name:"United States Military Academy",nick:"Black Knights",div:"NCAA D1",conf:"American",loc:"West Point, NY",country:"United States",state:"New York",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Tennis","Golf","Wrestling","Lacrosse"],scholarships:true,schNote:"Full tuition + stipend for all cadets.",tuition:"$0 (full scholarship)",accept:"10%",site:"army.edu",logo:"⭐",type:"Military",openings:{Football:"All positions",Wrestling:"All"},enrollment:4400,desc:"West Point provides a free world-class education with a $0 tuition in exchange for military service commitment. Army football plays on the national stage and the discipline, leadership, and brotherhood at West Point builds character unlike any other institution."},
  {id:82,name:"United States Naval Academy",nick:"Midshipmen",div:"NCAA D1",conf:"American",loc:"Annapolis, MD",country:"United States",state:"Maryland",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Tennis","Golf","Wrestling","Lacrosse","Sailing"],scholarships:true,schNote:"Full tuition + stipend for all midshipmen.",tuition:"$0 (full scholarship)",accept:"9%",site:"usna.edu",logo:"⚓",type:"Military",openings:{Football:"All",Wrestling:"All"},enrollment:4500,desc:"Navy provides a free elite education with a storied football tradition — the Army-Navy game is one of the most meaningful in sports. A naval officer commission after graduation opens doors in every sector of American life."},
  {id:83,name:"United States Air Force Academy",nick:"Falcons",div:"NCAA D1",conf:"Mountain West",loc:"Colorado Springs, CO",country:"United States",state:"Colorado",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Tennis","Golf","Wrestling","Lacrosse","Skiing"],scholarships:true,schNote:"Full tuition + stipend for all cadets.",tuition:"$0 (full scholarship)",accept:"11%",site:"usafa.edu",logo:"✈️",type:"Military",openings:{Football:"All",Wrestling:"All"},enrollment:4000,desc:"The Air Force Academy provides a free education with stunning Colorado scenery and one of the most respected athletic programs in the Mountain West. The high-altitude training environment is elite for distance runners and endurance athletes."},
  {id:84,name:"UTEP",nick:"Miners",div:"NCAA D1",conf:"CUSA",loc:"El Paso, TX",country:"United States",state:"Texas",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Tennis","Golf","Volleyball","Softball"],scholarships:true,schNote:"Full scholarships.",tuition:"$8,168 / $20,540",accept:"100%",site:"utep.edu",logo:"⛏️",type:"Public",openings:{Football:"All",Track:"All events",Basketball:"All"},enrollment:24000,desc:"UTEP is AthleteVault's home program — the Miners have a proud history with Don Haskins' 1966 national championship team that broke the color barrier in college basketball. The border culture, El Paso community, and CUSA competition make it a unique destination."},
  {id:85,name:"University of Texas San Antonio",nick:"Roadrunners",div:"NCAA D1",conf:"AAC",loc:"San Antonio, TX",country:"United States",state:"Texas",sports:["Football","Basketball","Baseball","Track","Soccer","Tennis","Golf","Volleyball","Softball"],scholarships:true,schNote:"Full scholarships.",tuition:"$7,742 / $18,890",accept:"87%",site:"utsa.edu",logo:"🐦",type:"Public",openings:{Football:"All",Basketball:"All"},enrollment:34000,desc:"UTSA is rapidly becoming one of the most exciting programs in college football — the Roadrunners went to back-to-back conference championships. San Antonio's growing market and AAC elevation make this a rising destination."},
  {id:86,name:"University of North Texas",nick:"Mean Green",div:"NCAA D1",conf:"AAC",loc:"Denton, TX",country:"United States",state:"Texas",sports:["Football","Basketball","Baseball","Track","Soccer","Tennis","Golf","Volleyball","Softball"],scholarships:true,schNote:"Full scholarships.",tuition:"$8,124 / $19,014",accept:"82%",site:"unt.edu",logo:"🦅",type:"Public",openings:{Football:"All",Track:"All events"},enrollment:45000,desc:"North Texas plays in the DFW Metroplex — one of the best recruiting markets in America. The Mean Green are a rising AAC program and the proximity to Dallas and Fort Worth provides massive NIL opportunities."},
  {id:87,name:"Sam Houston State",nick:"Bearkats",div:"NCAA D1",conf:"WAC",loc:"Huntsville, TX",country:"United States",state:"Texas",sports:["Football","Basketball","Baseball","Track","Soccer","Tennis","Golf","Softball","Volleyball"],scholarships:true,schNote:"Full scholarships.",tuition:"$7,386 / $16,674",accept:"78%",site:"shsu.edu",logo:"🐻",type:"Public",openings:{Football:"All positions",Basketball:"All"},enrollment:21000,desc:"Sam Houston State is a WAC powerhouse with elite FCS football tradition. The Bearkats have won multiple FCS championships and the program serves as a launching pad for players looking to move to FBS or professional football."},
  {id:88,name:"Appalachian State University",nick:"Mountaineers",div:"NCAA D1",conf:"Sun Belt",loc:"Boone, NC",country:"United States",state:"North Carolina",sports:["Football","Basketball","Baseball","Track","Soccer","Tennis","Golf","Volleyball","Wrestling"],scholarships:true,schNote:"Full scholarships.",tuition:"$7,594 / $21,850",accept:"71%",site:"appstate.edu",logo:"⛰️",type:"Public",openings:{Football:"All",Wrestling:"All"},enrollment:21000,desc:"App State shocked Michigan in 2007 in one of the greatest upsets in college football history. The mountain campus is stunning and the program consistently beats Power 4 teams. Boone's outdoor culture and tight community are unique."},
  {id:89,name:"Louisiana Lafayette",nick:"Ragin' Cajuns",div:"NCAA D1",conf:"Sun Belt",loc:"Lafayette, LA",country:"United States",state:"Louisiana",sports:["Football","Basketball","Baseball","Track","Soccer","Tennis","Golf","Softball","Volleyball"],scholarships:true,schNote:"Full scholarships.",tuition:"$5,892 / $18,388",accept:"63%",site:"louisiana.edu",logo:"🌶️",type:"Public",openings:{Football:"All",Baseball:"All",Track:"All"},enrollment:19000,desc:"ULL football is a Sun Belt dynasty — the Ragin' Cajuns have won multiple conference championships and consistently upset ranked opponents. Lafayette's Cajun culture, food, and music make it one of the most unique and lively college towns in America."},
  {id:90,name:"Georgia Southern University",nick:"Eagles",div:"NCAA D1",conf:"Sun Belt",loc:"Statesboro, GA",country:"United States",state:"Georgia",sports:["Football","Basketball","Baseball","Track","Soccer","Tennis","Golf","Volleyball","Softball"],scholarships:true,schNote:"Full scholarships.",tuition:"$6,124 / $17,886",accept:"89%",site:"georgiasouthern.edu",logo:"🦅",type:"Public",openings:{Football:"All",Baseball:"All"},enrollment:27000,desc:"Georgia Southern has the most wins in FCS history and won 6 national championships. The program moved to FBS and competes in the Sun Belt — a strong launching pad for players with professional aspirations."},
  {id:91,name:"Texas State University",nick:"Bobcats",div:"NCAA D1",conf:"Sun Belt",loc:"San Marcos, TX",country:"United States",state:"Texas",sports:["Football","Basketball","Baseball","Track","Soccer","Tennis","Golf","Volleyball","Softball"],scholarships:true,schNote:"Full scholarships.",tuition:"$8,242 / $18,856",accept:"60%",site:"txst.edu",logo:"🐱",type:"Public",openings:{Football:"All",Baseball:"All"},enrollment:38000,desc:"Texas State is a rapidly growing program in the heart of Texas between Austin and San Antonio. The Bobcats compete in the Sun Belt with strong football and baseball programs and the vibrant San Marcos outdoor culture."},
  {id:92,name:"Florida Atlantic University",nick:"Owls",div:"NCAA D1",conf:"AAC",loc:"Boca Raton, FL",country:"United States",state:"Florida",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Tennis","Golf","Volleyball","Softball"],scholarships:true,schNote:"Full scholarships.",tuition:"$4,316 / $17,324",accept:"58%",site:"fau.edu",logo:"🦉",type:"Public",openings:{Football:"All",Basketball:"All",Track:"All"},enrollment:30000,desc:"FAU made the Final Four in 2023 basketball — one of the great Cinderella stories in tournament history. The Owls football program had one of the greatest seasons in G5 history under Lane Kiffin and South Florida recruiting is elite."},
  // ── HBCUs (Core) ──
  {id:10,name:"Howard University",nick:"Bison",div:"NCAA D1",conf:"MEAC",loc:"Washington, DC",country:"United States",state:"DC",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Tennis","Golf","Volleyball","Lacrosse"],scholarships:true,schNote:"Athletic and academic scholarships available.",tuition:"$29,310",accept:"36%",site:"howard.edu",logo:"🦬",type:"HBCU",openings:{Football:"All",Basketball:"All",Track:"All events"},enrollment:11000,desc:"Howard University is the crown jewel of HBCUs — located in the nation's capital and producing generations of Black excellence including Kamala Harris, Chadwick Boseman, and Taraji P. Henson. The football program's revival and vibrant campus culture make Howard one of the most exciting HBCU destinations right now."},
  {id:11,name:"Grambling State University",nick:"Tigers",div:"NCAA D1",conf:"SWAC",loc:"Grambling, LA",country:"United States",state:"Louisiana",sports:["Football","Basketball","Baseball","Track","Soccer","Tennis","Volleyball","Softball"],scholarships:true,schNote:"Full athletic scholarships.",tuition:"$4,726 in-state",accept:"56%",site:"gram.edu",logo:"🐯",type:"HBCU",openings:{Football:"All positions",Basketball:"All",Track:"Sprinters"},enrollment:5100,desc:"Grambling State is a football institution — Coach Eddie Robinson built the greatest HBCU football dynasty in history with over 400 wins. The World-Famed Tiger Marching Band and passionate fanbase make Grambling game day one of the most memorable experiences in all of college sports."},
  {id:12,name:"Texas Southern University",nick:"Tigers",div:"NCAA D1",conf:"SWAC",loc:"Houston, TX",country:"United States",state:"Texas",sports:["Football","Basketball","Baseball","Track","Soccer","Tennis","Golf","Volleyball","Softball","Bowling"],scholarships:true,schNote:"Athletic scholarships available.",tuition:"$6,284 in-state",accept:"78%",site:"tsu.edu",logo:"🐯",type:"HBCU",openings:{Football:"All",Basketball:"Guards, forwards",Track:"All"},enrollment:8500,desc:"Texas Southern is Houston's HBCU — located in the 4th largest city in America with massive NIL market access and deep Texas recruiting roots. The Ocean of Soul marching band is world-famous and the program competes hard in one of the best HBCU conferences in the country."},
  {id:13,name:"Prairie View A&M University",nick:"Panthers",div:"NCAA D1",conf:"SWAC",loc:"Prairie View, TX",country:"United States",state:"Texas",sports:["Football","Basketball","Baseball","Track","Soccer","Tennis","Golf","Volleyball","Softball","Bowling"],scholarships:true,schNote:"Full athletic scholarships.",tuition:"$5,828 in-state",accept:"60%",site:"pvamu.edu",logo:"🐾",type:"HBCU",openings:{Football:"All",Basketball:"All",Track:"All events"},enrollment:8900,desc:"Prairie View A&M is in the Texas A&M University System and plays in the SWAC near Houston — one of the strongest recruiting markets in America. The Panthers have a proud football tradition and the university's STEM programs create strong career pathways for athletes."},
  {id:14,name:"Florida A&M University",nick:"Rattlers",div:"NCAA D1",conf:"SWAC",loc:"Tallahassee, FL",country:"United States",state:"Florida",sports:["Football","Basketball","Baseball","Track","Soccer","Tennis","Golf","Volleyball","Softball","Swimming"],scholarships:true,schNote:"Full athletic scholarships.",tuition:"$5,785 in-state",accept:"35%",site:"famu.edu",logo:"🐍",type:"HBCU",openings:{Football:"All positions",Track:"All events",Basketball:"All"},enrollment:10000,desc:"Florida A&M is one of the most selective HBCUs in America — the Rattlers compete with pride in the SWAC. The world-renowned Marching 100 band is considered one of the greatest college bands ever and the Tallahassee location puts FAMU in the heart of Florida's elite recruiting base."},
  {id:15,name:"Jackson State University",nick:"Tigers",div:"NCAA D1",conf:"SWAC",loc:"Jackson, MS",country:"United States",state:"Mississippi",sports:["Football","Basketball","Baseball","Track","Soccer","Tennis","Golf","Volleyball","Softball"],scholarships:true,schNote:"Full athletic scholarships.",tuition:"$3,880 in-state",accept:"47%",site:"jsums.edu",logo:"🐯",type:"HBCU",openings:{Football:"All positions",Track:"All events"},enrollment:7200,desc:"Jackson State became a national story when Deion Sanders arrived and delivered back-to-back SWAC championships — putting HBCU football on the national stage. Prime Time's legacy elevated JSU's recruiting and visibility and the Tigers continue to punch above their weight."},
  // ── More HBCUs ──
  {id:93,name:"NC A&T",nick:"Aggies",div:"NCAA D1",conf:"Big South",loc:"Greensboro, NC",country:"United States",state:"North Carolina",sports:["Football","Basketball","Track","Baseball","Soccer","Tennis","Golf","Volleyball","Softball"],scholarships:true,schNote:"Athletic + academic scholarships.",tuition:"$4,866 in-state",accept:"65%",site:"ncat.edu",logo:"🔵",type:"HBCU",openings:{Football:"All",Track:"All events",Basketball:"All"},enrollment:12000,desc:"NC A&T is the largest HBCU in America and the alma mater of Jesse Jackson, Ronald McNair, and Greensboro Four sit-in leaders. The track program has produced multiple Olympic medalists and the Greensboro Triad market is strong."},
  {id:94,name:"Morgan State University",nick:"Bears",div:"NCAA D1",conf:"MEAC",loc:"Baltimore, MD",country:"United States",state:"Maryland",sports:["Football","Basketball","Track","Baseball","Soccer","Tennis","Volleyball","Softball"],scholarships:true,schNote:"Athletic scholarships available.",tuition:"$7,680 in-state",accept:"63%",site:"morgan.edu",logo:"🐻",type:"HBCU",openings:{Football:"All",Basketball:"All",Track:"All"},enrollment:7500,desc:"Morgan State plays in Baltimore — a major East Coast city with growing NIL opportunities. The Bears football program is MEAC competitive and the proximity to Washington DC creates strong career and media networks."},
  {id:95,name:"Hampton University",nick:"Pirates",div:"NCAA D1",conf:"CAA",loc:"Hampton, VA",country:"United States",state:"Virginia",sports:["Football","Basketball","Track","Baseball","Soccer","Tennis","Volleyball","Softball","Sailing"],scholarships:true,schNote:"Athletic + academic scholarships.",tuition:"$26,010",accept:"34%",site:"hamptonu.edu",logo:"🏴‍☠️",type:"HBCU",openings:{Football:"All",Basketball:"All"},enrollment:3700,desc:"Hampton University is a prestigious HBCU with a waterfront campus on the Chesapeake Bay. The CAA conference provides strong mid-major competition and Hampton's selective admissions reflect its academic excellence."},
  {id:96,name:"Bethune-Cookman University",nick:"Wildcats",div:"NCAA D1",conf:"SWAC",loc:"Daytona Beach, FL",country:"United States",state:"Florida",sports:["Football","Basketball","Track","Baseball","Soccer","Tennis","Volleyball","Softball"],scholarships:true,schNote:"Athletic scholarships available.",tuition:"$15,680",accept:"36%",site:"cookman.edu",logo:"🐱",type:"HBCU",openings:{Football:"All",Basketball:"All",Track:"All"},enrollment:3200,desc:"Bethune-Cookman was founded by civil rights legend Mary McLeod Bethune and is located in Daytona Beach — prime Florida recruiting territory. The SWAC schedule provides HBCU championship competition."},
  {id:97,name:"Alcorn State University",nick:"Braves",div:"NCAA D1",conf:"SWAC",loc:"Lorman, MS",country:"United States",state:"Mississippi",sports:["Football","Basketball","Track","Baseball","Volleyball","Softball"],scholarships:true,schNote:"Full athletic scholarships.",tuition:"$3,512 in-state",accept:"47%",site:"alcorn.edu",logo:"🪶",type:"HBCU",openings:{Football:"All positions"},enrollment:3500,desc:"Alcorn State is the alma mater of Jack Youngblood and Steve McNair — one of the great SWAC football programs. The affordable cost and Mississippi culture make it accessible for athletes seeking HBCU experience."},
  {id:98,name:"Southern University",nick:"Jaguars",div:"NCAA D1",conf:"SWAC",loc:"Baton Rouge, LA",country:"United States",state:"Louisiana",sports:["Football","Basketball","Track","Baseball","Volleyball","Soccer"],scholarships:true,schNote:"Full athletic scholarships.",tuition:"$4,924 in-state",accept:"47%",site:"southern.edu",logo:"🐆",type:"HBCU",openings:{Football:"All",Track:"All",Basketball:"All"},enrollment:6800,desc:"Southern University is home to the Human Jukebox — one of the most legendary marching bands in America. The Jaguars football program is a SWAC powerhouse and Baton Rouge provides strong community support."},
  {id:99,name:"Norfolk State University",nick:"Spartans",div:"NCAA D1",conf:"MEAC",loc:"Norfolk, VA",country:"United States",state:"Virginia",sports:["Football","Basketball","Track","Baseball","Soccer","Tennis","Volleyball","Softball"],scholarships:true,schNote:"Athletic scholarships available.",tuition:"$8,832 in-state",accept:"88%",site:"nsu.edu",logo:"⚔️",type:"HBCU",openings:{Football:"All",Basketball:"All",Track:"All"},enrollment:5500,desc:"Norfolk State upset Missouri in the 2012 NCAA tournament — one of the great upsets in March Madness history. The Hampton Roads military community and Norfolk Naval Station create strong career networks for student athletes."},
  {id:100,name:"Tuskegee University",nick:"Golden Tigers",div:"NCAA D2",conf:"SIAC",loc:"Tuskegee, AL",country:"United States",state:"Alabama",sports:["Football","Basketball","Track","Baseball","Tennis","Volleyball"],scholarships:true,schNote:"Athletic + academic scholarships.",tuition:"$22,100",accept:"42%",site:"tuskegee.edu",logo:"🐯",type:"HBCU",openings:{Football:"All"},enrollment:2500,desc:"Tuskegee is the alma mater of Booker T. Washington and has one of the richest histories of any American institution. The Golden Tigers football program is a SIAC powerhouse and a Tuskegee degree is one of the most respected HBCU credentials."},
  // ── NCAA D2 ──
  {id:16,name:"Midwestern State",nick:"Mustangs",div:"NCAA D2",conf:"Lone Star",loc:"Wichita Falls, TX",country:"United States",state:"Texas",sports:["Football","Basketball","Baseball","Track","Soccer","Tennis"],scholarships:true,schNote:"Partial to full scholarships.",tuition:"$6,400 in-state",accept:"75%",site:"msutexas.edu",logo:"🐎",type:"Public",openings:{Football:"WR, DB",Soccer:"Forward, MF"},enrollment:5500,desc:"Midwestern State is a Lone Star Conference power with affordable tuition and strong athletic programs. The Texas Panhandle location offers a tight-knit community and strong pathway to professional athletics."},
  {id:101,name:"Grand Valley State University",nick:"Lakers",div:"NCAA D2",conf:"GLIAC",loc:"Allendale, MI",country:"United States",state:"Michigan",sports:["Football","Basketball","Baseball","Track","Soccer","Swimming","Tennis","Golf","Volleyball","Softball"],scholarships:true,schNote:"Partial scholarships.",tuition:"$13,154 / $18,736",accept:"83%",site:"gvsu.edu",logo:"🏊",type:"Public",openings:{Football:"All",Track:"All"},enrollment:24000,desc:"Grand Valley State is a D2 dynasty — the Lakers have won multiple national championships in football and field hockey. The West Michigan location and strong alumni network create excellent post-athletic career pathways."},
  {id:102,name:"Angelo State University",nick:"Rams",div:"NCAA D2",conf:"Lone Star",loc:"San Angelo, TX",country:"United States",state:"Texas",sports:["Football","Basketball","Baseball","Track","Soccer","Tennis","Golf","Volleyball","Softball"],scholarships:true,schNote:"Full scholarships available.",tuition:"$6,500 in-state",accept:"68%",site:"angelo.edu",logo:"🐏",type:"Public",openings:{Football:"All",Track:"All events",Baseball:"All"},enrollment:10000,desc:"Angelo State is a Lone Star Conference powerhouse — the Rams football program consistently contends for D2 national championships. The West Texas community and affordable education make it an excellent D2 destination."},
  {id:103,name:"West Texas A&M University",nick:"Buffs",div:"NCAA D2",conf:"Lone Star",loc:"Canyon, TX",country:"United States",state:"Texas",sports:["Football","Basketball","Baseball","Track","Soccer","Tennis","Golf","Volleyball","Softball"],scholarships:true,schNote:"Partial to full scholarships.",tuition:"$6,788 in-state",accept:"61%",site:"wtamu.edu",logo:"🦬",type:"Public",openings:{Football:"All",Basketball:"All"},enrollment:10000,desc:"West Texas A&M is a consistent Lone Star Conference contender in the Amarillo area. The Buffs football program is a regional powerhouse and the affordable Texas Panhandle location makes it accessible for athletes from across the country."},
  {id:104,name:"Valdosta State University",nick:"Blazers",div:"NCAA D2",conf:"Gulf South",loc:"Valdosta, GA",country:"United States",state:"Georgia",sports:["Football","Basketball","Baseball","Track","Soccer","Tennis","Golf","Volleyball","Softball"],scholarships:true,schNote:"Full scholarships.",tuition:"$5,540 in-state",accept:"60%",site:"valdosta.edu",logo:"🔥",type:"Public",openings:{Football:"All positions",Basketball:"All"},enrollment:11000,desc:"Valdosta State football has won 3 D2 national championships — one of the most successful small-college programs in history. South Georgia recruiting and the Gulf South Conference provide a competitive path to professional athletics."},
  {id:105,name:"Ferris State University",nick:"Bulldogs",div:"NCAA D2",conf:"GLIAC",loc:"Big Rapids, MI",country:"United States",state:"Michigan",sports:["Football","Basketball","Baseball","Track","Soccer","Tennis","Golf","Volleyball","Hockey"],scholarships:true,schNote:"Partial scholarships.",tuition:"$12,936 / $19,072",accept:"83%",site:"ferris.edu",logo:"🐕",type:"Public",openings:{Football:"All",Hockey:"All"},enrollment:14000,desc:"Ferris State football won the 2021 and 2022 D2 national championships back-to-back — the Bulldogs are the gold standard of D2 football. The hockey program competes at an elite level and the Michigan recruiting market is rich."},
  // ── NAIA ──
  {id:20,name:"Benedictine College",nick:"Ravens",div:"NAIA",conf:"Heart of America",loc:"Atchison, KS",country:"United States",state:"Kansas",sports:["Football","Basketball","Baseball","Track","Soccer","Tennis","Golf"],scholarships:true,schNote:"Athletic + academic scholarships.",tuition:"$32,000",accept:"62%",site:"benedictine.edu",logo:"🦅",type:"NAIA",openings:{Football:"QB, WR, OL",Basketball:"All"},enrollment:2500,desc:"Benedictine College is an NAIA football powerhouse that regularly beats FCS and lower FBS programs. The Catholic liberal arts mission, Kansas City proximity, and championship culture make it a top NAIA destination."},
  {id:106,name:"Morningside University",nick:"Mustangs",div:"NAIA",conf:"Great Plains",loc:"Sioux City, IA",country:"United States",state:"Iowa",sports:["Football","Basketball","Baseball","Track","Soccer","Tennis","Golf","Volleyball","Softball"],scholarships:true,schNote:"Generous athletic and academic scholarships.",tuition:"$33,600",accept:"68%",site:"morningside.edu",logo:"🐴",type:"NAIA",openings:{Football:"All positions",Basketball:"All"},enrollment:1800,desc:"Morningside football has won multiple NAIA national championships and consistently ranks among the top small-college programs in America. The coaching staff has exceptional player development records."},
  {id:107,name:"Lindsey Wilson College",nick:"Blue Raiders",div:"NAIA",conf:"Mid-South",loc:"Columbia, KY",country:"United States",state:"Kentucky",sports:["Football","Basketball","Baseball","Track","Soccer","Tennis","Golf","Volleyball","Softball","Cross Country"],scholarships:true,schNote:"Generous scholarships available.",tuition:"$27,800",accept:"50%",site:"lindsey.edu",logo:"🔵",type:"NAIA",openings:{Football:"All",Soccer:"All",Basketball:"All"},enrollment:3200,desc:"Lindsey Wilson is an NAIA football and soccer powerhouse in rural Kentucky. The Blue Raiders regularly reach NAIA national championships and the coaching staff is known for developing undiscovered talent."},
  // ── JUCO ──
  {id:17,name:"Tarleton State",nick:"Texans",div:"NCAA D1",conf:"WAC",loc:"Stephenville, TX",country:"United States",state:"Texas",sports:["Football","Basketball","Baseball","Track","Soccer"],scholarships:true,schNote:"Full scholarships. Recently moved to D1.",tuition:"$8,000 in-state",accept:"60%",site:"tarleton.edu",logo:"🐂",type:"Public",openings:{Football:"All positions",Basketball:"Guards"},enrollment:14000,desc:"Tarleton State is a rising WAC program making the FBS transition. Stephenville is Texas ranching country and the program offers a path for athletes who want to compete at the D1 level with a growing program."},
  {id:18,name:"Kilgore College",nick:"Rangers",div:"NJCAA",conf:"SWJCFC",loc:"Kilgore, TX",country:"United States",state:"Texas",sports:["Football","Basketball","Baseball","Track","Soccer"],scholarships:true,schNote:"Full JUCO scholarships. Pipeline to D1.",tuition:"$1,800 in-state",accept:"100%",site:"kilgore.edu",logo:"⚡",type:"JUCO",openings:{Football:"All positions",Basketball:"All"},enrollment:5800,desc:"Kilgore College is one of the most successful JUCO football programs in Texas history — a proving ground for players who need to establish themselves before moving to D1. The pipeline to major programs is well-established."},
  {id:19,name:"Blinn College",nick:"Buccaneers",div:"NJCAA",conf:"Southern JC",loc:"Brenham, TX",country:"United States",state:"Texas",sports:["Football","Basketball","Baseball","Track","Soccer"],scholarships:true,schNote:"Full JUCO scholarships. Strong transfer pipeline.",tuition:"$1,600 in-state",accept:"100%",site:"blinn.edu",logo:"🏴‍☠️",type:"JUCO",openings:{Football:"All skill positions"},enrollment:18000,desc:"Blinn College is one of the most famous JUCO programs in America — Von Miller, Spencer Rattler, and dozens of other NFL players passed through Blinn. It's the perfect restart for athletes who need another shot."},
  {id:108,name:"Tyler Junior College",nick:"Apaches",div:"NJCAA",conf:"SWJCFC",loc:"Tyler, TX",country:"United States",state:"Texas",sports:["Football","Basketball","Baseball","Track","Soccer","Tennis","Golf","Softball"],scholarships:true,schNote:"Full JUCO scholarships.",tuition:"$2,280 in-state",accept:"100%",site:"tjc.edu",logo:"🪶",type:"JUCO",openings:{Football:"All",Basketball:"All",Track:"All"},enrollment:13000,desc:"Tyler JC is one of the premier JUCO programs in East Texas — a gateway to major D1 programs for athletes needing development time. The deep East Texas recruiting base and successful coaching staff make it a strong JUCO choice."},
  {id:109,name:"Navarro College",nick:"Bulldogs",div:"NJCAA",conf:"SWJCFC",loc:"Corsicana, TX",country:"United States",state:"Texas",sports:["Football","Basketball","Baseball","Track","Volleyball","Softball","Cheerleading"],scholarships:true,schNote:"Full JUCO scholarships.",tuition:"$3,010 in-state",accept:"100%",site:"navarrocollege.edu",logo:"🐕",type:"JUCO",openings:{Football:"All",Basketball:"All",Cheerleading:"All"},enrollment:12000,desc:"Navarro College was made famous by Netflix's Cheer documentary — the cheerleading program is the most decorated in JUCO history. The football and basketball programs are strong stepping stones to 4-year programs."},
  {id:110,name:"Iowa Western Community College",nick:"Reivers",div:"NJCAA",conf:"ICCAC",loc:"Council Bluffs, IA",country:"United States",state:"Iowa",sports:["Football","Basketball","Baseball","Track","Soccer","Volleyball","Softball"],scholarships:true,schNote:"Full JUCO scholarships.",tuition:"$5,520 in-state",accept:"100%",site:"iowawestern.edu",logo:"🌽",type:"JUCO",openings:{Football:"All positions",Basketball:"All"},enrollment:6000,desc:"Iowa Western is the top JUCO program in the Midwest — the football team regularly sends players to D1 programs and the Omaha/Council Bluffs metro provides a strong athletic environment."},
  {id:111,name:"Hutchinson Community College",nick:"Blue Dragons",div:"NJCAA",conf:"KJCCC",loc:"Hutchinson, KS",country:"United States",state:"Kansas",sports:["Football","Basketball","Baseball","Track","Volleyball","Softball"],scholarships:true,schNote:"Full JUCO scholarships.",tuition:"$3,720 in-state",accept:"100%",site:"hutchcc.edu",logo:"🐉",type:"JUCO",openings:{Football:"All",Basketball:"All"},enrollment:5000,desc:"Hutchinson CC is a national JUCO football powerhouse with multiple national championships. The Blue Dragons are widely respected in the junior college world as a program that develops players for D1 programs nationwide."},
];

// ── School Contact / Apply / Jobs Data ─────────
const SCHOOL_CONTACTS={
  1:{applyUrl:"https://admissions.utexas.edu/apply",athleticsUrl:"https://texassports.com",recruitingEmail:"athletics@utexas.edu",jobsUrl:"https://utexas.edu/jobs"},
  2:{applyUrl:"https://apply.ua.edu",athleticsUrl:"https://rolltide.com",recruitingEmail:"recruiting@rolltide.com",jobsUrl:"https://rolltide.com/sports/2020/6/10/staff-directory.aspx"},
  3:{applyUrl:"https://undergrad.osu.edu/apply",athleticsUrl:"https://ohiostatebuckeyes.com",recruitingEmail:"recruiting@ohiostatebuckeyes.com",jobsUrl:"https://ohiostatebuckeyes.com/staff-directory"},
  4:{applyUrl:"https://applylsu.lsu.edu",athleticsUrl:"https://lsusports.net",recruitingEmail:"athletics@lsu.edu",jobsUrl:"https://lsusports.net/staff-directory"},
  5:{applyUrl:"https://admissions.ufl.edu/apply",athleticsUrl:"https://floridagators.com",recruitingEmail:"athletics@ufl.edu",jobsUrl:"https://floridagators.com/staff-directory"},
  6:{applyUrl:"https://apply.uga.edu",athleticsUrl:"https://georgiadogs.com",recruitingEmail:"recruiting@georgiadogs.com",jobsUrl:"https://georgiadogs.com/staff-directory"},
  7:{applyUrl:"https://admissions.tamu.edu/apply",athleticsUrl:"https://aggieathletics.com",recruitingEmail:"athletics@tamu.edu",jobsUrl:"https://aggieathletics.com/staff-directory"},
  8:{applyUrl:"https://apply.nd.edu",athleticsUrl:"https://und.com",recruitingEmail:"athletics@nd.edu",jobsUrl:"https://und.com/staff-directory"},
  9:{applyUrl:"https://admissions.uoregon.edu/apply",athleticsUrl:"https://goducks.com",recruitingEmail:"athletics@uoregon.edu",jobsUrl:"https://goducks.com/staff-directory"},
  10:{applyUrl:"https://apply.howard.edu",athleticsUrl:"https://howard.edu/athletics",recruitingEmail:"athletics@howard.edu",jobsUrl:"https://howard.edu/athletics/jobs"},
  11:{applyUrl:"https://gram.edu/admissions",athleticsUrl:"https://gsutigers.com",recruitingEmail:"athletics@gram.edu",jobsUrl:"https://gsutigers.com/staff-directory"},
  12:{applyUrl:"https://tsu.edu/admissions",athleticsUrl:"https://tsuathletics.com",recruitingEmail:"athletics@tsu.edu",jobsUrl:"https://tsuathletics.com/staff-directory"},
  13:{applyUrl:"https://pvamu.edu/admissions",athleticsUrl:"https://pvamu.edu/athletics",recruitingEmail:"athletics@pvamu.edu",jobsUrl:"https://pvamu.edu/athletics/jobs"},
  14:{applyUrl:"https://famu.edu/admissions",athleticsUrl:"https://famuathletics.com",recruitingEmail:"athletics@famu.edu",jobsUrl:"https://famuathletics.com/staff-directory"},
  15:{applyUrl:"https://jsums.edu/admissions",athleticsUrl:"https://jsums.edu/athletics",recruitingEmail:"athletics@jsums.edu",jobsUrl:"https://jsums.edu/athletics/jobs"},
  16:{applyUrl:"https://msutexas.edu/apply",athleticsUrl:"https://mwsumustangs.com",recruitingEmail:"athletics@msutexas.edu",jobsUrl:"https://mwsumustangs.com/staff-directory"},
  17:{applyUrl:"https://tarleton.edu/apply",athleticsUrl:"https://tarletonsports.com",recruitingEmail:"athletics@tarleton.edu",jobsUrl:"https://tarletonsports.com/staff-directory"},
  18:{applyUrl:"https://kilgore.edu/admissions",athleticsUrl:"https://kcranger.com",recruitingEmail:"athletics@kilgore.edu",jobsUrl:"https://kcranger.com/staff-directory"},
  19:{applyUrl:"https://blinn.edu/admissions",athleticsUrl:"https://blinnathletics.com",recruitingEmail:"athletics@blinn.edu",jobsUrl:"https://blinnathletics.com/staff-directory"},
  20:{applyUrl:"https://benedictine.edu/admissions/apply",athleticsUrl:"https://bcravens.com",recruitingEmail:"athletics@benedictine.edu",jobsUrl:"https://bcravens.com/staff-directory"},
  // SEC (continued)
  21:{applyUrl:"https://auburn.edu/admissions",athleticsUrl:"https://auburntigers.com",recruitingEmail:"athletics@auburn.edu",jobsUrl:"https://auburntigers.com/staff-directory"},
  22:{applyUrl:"https://admissions.utk.edu",athleticsUrl:"https://utsports.com",recruitingEmail:"athletics@utk.edu",jobsUrl:"https://utsports.com/staff-directory"},
  23:{applyUrl:"https://admissions.olemiss.edu",athleticsUrl:"https://olemisssports.com",recruitingEmail:"athletics@olemiss.edu",jobsUrl:"https://olemisssports.com/staff-directory"},
  24:{applyUrl:"https://admissions.msstate.edu",athleticsUrl:"https://hailstate.com",recruitingEmail:"athletics@msstate.edu",jobsUrl:"https://hailstate.com/staff-directory"},
  25:{applyUrl:"https://admissions.uark.edu",athleticsUrl:"https://razorbacksports.com",recruitingEmail:"athletics@uark.edu",jobsUrl:"https://razorbacksports.com/staff-directory"},
  26:{applyUrl:"https://admissions.sc.edu",athleticsUrl:"https://gamecocksonline.com",recruitingEmail:"athletics@sc.edu",jobsUrl:"https://gamecocksonline.com/staff-directory"},
  27:{applyUrl:"https://admissions.missouri.edu",athleticsUrl:"https://mutigers.com",recruitingEmail:"athletics@missouri.edu",jobsUrl:"https://mutigers.com/staff-directory"},
  28:{applyUrl:"https://admissions.vanderbilt.edu",athleticsUrl:"https://vucommodores.com",recruitingEmail:"athletics@vanderbilt.edu",jobsUrl:"https://vucommodores.com/staff-directory"},
  29:{applyUrl:"https://www.uky.edu/admissions",athleticsUrl:"https://ukathletics.com",recruitingEmail:"athletics@uky.edu",jobsUrl:"https://ukathletics.com/staff-directory"},
  30:{applyUrl:"https://www.ou.edu/admissions",athleticsUrl:"https://soonersports.com",recruitingEmail:"athletics@ou.edu",jobsUrl:"https://soonersports.com/staff-directory"},
  // Big Ten
  31:{applyUrl:"https://admissions.umich.edu",athleticsUrl:"https://mgoblue.com",recruitingEmail:"athletics@umich.edu",jobsUrl:"https://mgoblue.com/staff-directory"},
  32:{applyUrl:"https://admissions.psu.edu",athleticsUrl:"https://gopsusports.com",recruitingEmail:"athletics@psu.edu",jobsUrl:"https://gopsusports.com/staff-directory"},
  33:{applyUrl:"https://admissions.msu.edu",athleticsUrl:"https://msuspartans.com",recruitingEmail:"athletics@msu.edu",jobsUrl:"https://msuspartans.com/staff-directory"},
  34:{applyUrl:"https://admissions.uiowa.edu",athleticsUrl:"https://hawkeyesports.com",recruitingEmail:"athletics@uiowa.edu",jobsUrl:"https://hawkeyesports.com/staff-directory"},
  35:{applyUrl:"https://admissions.wisc.edu",athleticsUrl:"https://uwbadgers.com",recruitingEmail:"athletics@wisc.edu",jobsUrl:"https://uwbadgers.com/staff-directory"},
  36:{applyUrl:"https://admissions.umn.edu",athleticsUrl:"https://gophersports.com",recruitingEmail:"athletics@umn.edu",jobsUrl:"https://gophersports.com/staff-directory"},
  37:{applyUrl:"https://admissions.unl.edu",athleticsUrl:"https://huskers.com",recruitingEmail:"athletics@unl.edu",jobsUrl:"https://huskers.com/staff-directory"},
  38:{applyUrl:"https://admissions.umd.edu",athleticsUrl:"https://umterps.com",recruitingEmail:"athletics@umd.edu",jobsUrl:"https://umterps.com/staff-directory"},
  39:{applyUrl:"https://admissions.rutgers.edu",athleticsUrl:"https://scarletknights.com",recruitingEmail:"athletics@rutgers.edu",jobsUrl:"https://scarletknights.com/staff-directory"},
  40:{applyUrl:"https://admissions.indiana.edu",athleticsUrl:"https://iuhoosiers.com",recruitingEmail:"athletics@indiana.edu",jobsUrl:"https://iuhoosiers.com/staff-directory"},
  41:{applyUrl:"https://admissions.illinois.edu",athleticsUrl:"https://fightingillini.com",recruitingEmail:"athletics@illinois.edu",jobsUrl:"https://fightingillini.com/staff-directory"},
  42:{applyUrl:"https://admissions.purdue.edu",athleticsUrl:"https://purduesports.com",recruitingEmail:"athletics@purdue.edu",jobsUrl:"https://purduesports.com/staff-directory"},
  43:{applyUrl:"https://admissions.northwestern.edu",athleticsUrl:"https://nusports.com",recruitingEmail:"athletics@northwestern.edu",jobsUrl:"https://nusports.com/staff-directory"},
  44:{applyUrl:"https://admissions.ucla.edu",athleticsUrl:"https://uclabruins.com",recruitingEmail:"athletics@ucla.edu",jobsUrl:"https://uclabruins.com/staff-directory"},
  45:{applyUrl:"https://admission.usc.edu",athleticsUrl:"https://usctrojans.com",recruitingEmail:"athletics@usc.edu",jobsUrl:"https://usctrojans.com/staff-directory"},
  46:{applyUrl:"https://admissions.washington.edu",athleticsUrl:"https://gohuskies.com",recruitingEmail:"athletics@washington.edu",jobsUrl:"https://gohuskies.com/staff-directory"},
  // ACC
  47:{applyUrl:"https://admissions.clemson.edu",athleticsUrl:"https://clemsontigers.com",recruitingEmail:"athletics@clemson.edu",jobsUrl:"https://clemsontigers.com/staff-directory"},
  48:{applyUrl:"https://admissions.fsu.edu",athleticsUrl:"https://seminoles.com",recruitingEmail:"athletics@fsu.edu",jobsUrl:"https://seminoles.com/staff-directory"},
  49:{applyUrl:"https://admissions.miami.edu",athleticsUrl:"https://hurricanesports.com",recruitingEmail:"athletics@miami.edu",jobsUrl:"https://hurricanesports.com/staff-directory"},
  50:{applyUrl:"https://admissions.duke.edu",athleticsUrl:"https://goduke.com",recruitingEmail:"athletics@duke.edu",jobsUrl:"https://goduke.com/staff-directory"},
  51:{applyUrl:"https://admissions.unc.edu",athleticsUrl:"https://goheels.com",recruitingEmail:"athletics@unc.edu",jobsUrl:"https://goheels.com/staff-directory"},
  52:{applyUrl:"https://admissions.ncsu.edu",athleticsUrl:"https://gopack.com",recruitingEmail:"athletics@ncsu.edu",jobsUrl:"https://gopack.com/staff-directory"},
  53:{applyUrl:"https://admission.gatech.edu",athleticsUrl:"https://ramblinwreck.com",recruitingEmail:"athletics@gatech.edu",jobsUrl:"https://ramblinwreck.com/staff-directory"},
  54:{applyUrl:"https://admissions.virginia.edu",athleticsUrl:"https://virginiasports.com",recruitingEmail:"athletics@virginia.edu",jobsUrl:"https://virginiasports.com/staff-directory"},
  55:{applyUrl:"https://admissions.vt.edu",athleticsUrl:"https://hokiesports.com",recruitingEmail:"athletics@vt.edu",jobsUrl:"https://hokiesports.com/staff-directory"},
  56:{applyUrl:"https://admissions.syracuse.edu",athleticsUrl:"https://cuse.com",recruitingEmail:"athletics@syr.edu",jobsUrl:"https://cuse.com/staff-directory"},
  57:{applyUrl:"https://admissions.louisville.edu",athleticsUrl:"https://gocards.com",recruitingEmail:"athletics@louisville.edu",jobsUrl:"https://gocards.com/staff-directory"},
  58:{applyUrl:"https://admissions.pitt.edu",athleticsUrl:"https://pittsburghpanthers.com",recruitingEmail:"athletics@pitt.edu",jobsUrl:"https://pittsburghpanthers.com/staff-directory"},
  59:{applyUrl:"https://admission.stanford.edu",athleticsUrl:"https://gostanford.com",recruitingEmail:"athletics@stanford.edu",jobsUrl:"https://gostanford.com/staff-directory"},
  60:{applyUrl:"https://admissions.bc.edu",athleticsUrl:"https://bceagles.com",recruitingEmail:"athletics@bc.edu",jobsUrl:"https://bceagles.com/staff-directory"},
  61:{applyUrl:"https://admissions.wfu.edu",athleticsUrl:"https://godeacs.com",recruitingEmail:"athletics@wfu.edu",jobsUrl:"https://godeacs.com/staff-directory"},
  // Big 12
  62:{applyUrl:"https://admissions.okstate.edu",athleticsUrl:"https://okstate.com",recruitingEmail:"athletics@okstate.edu",jobsUrl:"https://okstate.com/staff-directory"},
  63:{applyUrl:"https://admissions.ku.edu",athleticsUrl:"https://kuathletics.com",recruitingEmail:"athletics@ku.edu",jobsUrl:"https://kuathletics.com/staff-directory"},
  64:{applyUrl:"https://admissions.k-state.edu",athleticsUrl:"https://kstatesports.com",recruitingEmail:"athletics@ksu.edu",jobsUrl:"https://kstatesports.com/staff-directory"},
  65:{applyUrl:"https://admissions.iastate.edu",athleticsUrl:"https://cyclones.com",recruitingEmail:"athletics@iastate.edu",jobsUrl:"https://cyclones.com/staff-directory"},
  66:{applyUrl:"https://admissions.tcu.edu",athleticsUrl:"https://gofrogs.com",recruitingEmail:"athletics@tcu.edu",jobsUrl:"https://gofrogs.com/staff-directory"},
  67:{applyUrl:"https://admissions.baylor.edu",athleticsUrl:"https://baylorbears.com",recruitingEmail:"athletics@baylor.edu",jobsUrl:"https://baylorbears.com/staff-directory"},
  68:{applyUrl:"https://admissions.wvu.edu",athleticsUrl:"https://wvusports.com",recruitingEmail:"athletics@wvu.edu",jobsUrl:"https://wvusports.com/staff-directory"},
  69:{applyUrl:"https://admissions.uc.edu",athleticsUrl:"https://gobearcats.com",recruitingEmail:"athletics@uc.edu",jobsUrl:"https://gobearcats.com/staff-directory"},
  70:{applyUrl:"https://admissions.byu.edu",athleticsUrl:"https://byucougars.com",recruitingEmail:"athletics@byu.edu",jobsUrl:"https://byucougars.com/staff-directory"},
  71:{applyUrl:"https://uh.edu/admissions",athleticsUrl:"https://uhcougars.com",recruitingEmail:"athletics@uh.edu",jobsUrl:"https://uhcougars.com/staff-directory"},
  72:{applyUrl:"https://admissions.ucf.edu",athleticsUrl:"https://ucfknights.com",recruitingEmail:"athletics@ucf.edu",jobsUrl:"https://ucfknights.com/staff-directory"},
  73:{applyUrl:"https://admissions.arizona.edu",athleticsUrl:"https://arizonawildcats.com",recruitingEmail:"athletics@arizona.edu",jobsUrl:"https://arizonawildcats.com/staff-directory"},
  74:{applyUrl:"https://admissions.asu.edu",athleticsUrl:"https://thesundevils.com",recruitingEmail:"athletics@asu.edu",jobsUrl:"https://thesundevils.com/staff-directory"},
  75:{applyUrl:"https://admissions.colorado.edu",athleticsUrl:"https://cubuffs.com",recruitingEmail:"athletics@colorado.edu",jobsUrl:"https://cubuffs.com/staff-directory"},
  76:{applyUrl:"https://admissions.utah.edu",athleticsUrl:"https://utahutes.com",recruitingEmail:"athletics@utah.edu",jobsUrl:"https://utahutes.com/staff-directory"},
  // Other D1
  77:{applyUrl:"https://admissions.boisestate.edu",athleticsUrl:"https://broncosports.com",recruitingEmail:"athletics@boisestate.edu",jobsUrl:"https://broncosports.com/staff-directory"},
  78:{applyUrl:"https://admissions.sdsu.edu",athleticsUrl:"https://goaztecs.com",recruitingEmail:"athletics@sdsu.edu",jobsUrl:"https://goaztecs.com/staff-directory"},
  79:{applyUrl:"https://admissions.memphis.edu",athleticsUrl:"https://gotigersgo.com",recruitingEmail:"athletics@memphis.edu",jobsUrl:"https://gotigersgo.com/staff-directory"},
  80:{applyUrl:"https://admissions.tulane.edu",athleticsUrl:"https://tulanegreenwave.com",recruitingEmail:"athletics@tulane.edu",jobsUrl:"https://tulanegreenwave.com/staff-directory"},
  81:{applyUrl:"https://admissions.usma.edu",athleticsUrl:"https://goarmywestpoint.com",recruitingEmail:"athletics@usma.edu",jobsUrl:"https://goarmywestpoint.com/staff-directory"},
  82:{applyUrl:"https://www.usna.edu/Admissions",athleticsUrl:"https://navysports.com",recruitingEmail:"athletics@usna.edu",jobsUrl:"https://navysports.com/staff-directory"},
  83:{applyUrl:"https://admissions.usafa.edu",athleticsUrl:"https://goairforcefalcons.com",recruitingEmail:"athletics@usafa.edu",jobsUrl:"https://goairforcefalcons.com/staff-directory"},
  84:{applyUrl:"https://utep.edu/admissions",athleticsUrl:"https://miners.utep.edu",recruitingEmail:"athletics@utep.edu",jobsUrl:"https://miners.utep.edu/staff-directory"},
  85:{applyUrl:"https://admissions.utsa.edu",athleticsUrl:"https://utsaroadrunners.com",recruitingEmail:"athletics@utsa.edu",jobsUrl:"https://utsaroadrunners.com/staff-directory"},
  86:{applyUrl:"https://admissions.unt.edu",athleticsUrl:"https://meangreensports.com",recruitingEmail:"athletics@unt.edu",jobsUrl:"https://meangreensports.com/staff-directory"},
  87:{applyUrl:"https://shsu.edu/admissions",athleticsUrl:"https://gobearkats.com",recruitingEmail:"athletics@shsu.edu",jobsUrl:"https://gobearkats.com/staff-directory"},
  88:{applyUrl:"https://admissions.appstate.edu",athleticsUrl:"https://appstatesports.com",recruitingEmail:"athletics@appstate.edu",jobsUrl:"https://appstatesports.com/staff-directory"},
  89:{applyUrl:"https://louisiana.edu/admissions",athleticsUrl:"https://ragincajuns.com",recruitingEmail:"athletics@louisiana.edu",jobsUrl:"https://ragincajuns.com/staff-directory"},
  90:{applyUrl:"https://admissions.georgiasouthern.edu",athleticsUrl:"https://gseagles.com",recruitingEmail:"athletics@georgiasouthern.edu",jobsUrl:"https://gseagles.com/staff-directory"},
  91:{applyUrl:"https://admissions.txst.edu",athleticsUrl:"https://txstatebobcats.com",recruitingEmail:"athletics@txst.edu",jobsUrl:"https://txstatebobcats.com/staff-directory"},
  92:{applyUrl:"https://admissions.fau.edu",athleticsUrl:"https://fausports.com",recruitingEmail:"athletics@fau.edu",jobsUrl:"https://fausports.com/staff-directory"},
  // HBCUs
  93:{applyUrl:"https://admissions.ncat.edu",athleticsUrl:"https://ncataggies.com",recruitingEmail:"athletics@ncat.edu",jobsUrl:"https://ncataggies.com/staff-directory"},
  94:{applyUrl:"https://www.morgan.edu/admissions",athleticsUrl:"https://morganstatebears.com",recruitingEmail:"athletics@morgan.edu",jobsUrl:"https://morganstatebears.com/staff-directory"},
  95:{applyUrl:"https://hamptonu.edu/admissions",athleticsUrl:"https://hamptonpirates.com",recruitingEmail:"athletics@hamptonu.edu",jobsUrl:"https://hamptonpirates.com/staff-directory"},
  96:{applyUrl:"https://www.cookman.edu/admissions",athleticsUrl:"https://bcuwildcats.com",recruitingEmail:"athletics@cookman.edu",jobsUrl:"https://bcuwildcats.com/staff-directory"},
  97:{applyUrl:"https://www.alcorn.edu/admissions",athleticsUrl:"https://alcornsports.com",recruitingEmail:"athletics@alcorn.edu",jobsUrl:"https://alcornsports.com/staff-directory"},
  98:{applyUrl:"https://www.subr.edu/admissions",athleticsUrl:"https://sujaguars.com",recruitingEmail:"athletics@subr.edu",jobsUrl:"https://sujaguars.com/staff-directory"},
  99:{applyUrl:"https://nsu.edu/admissions",athleticsUrl:"https://nsuspartans.com",recruitingEmail:"athletics@nsu.edu",jobsUrl:"https://nsuspartans.com/staff-directory"},
  100:{applyUrl:"https://www.tuskegee.edu/admissions",athleticsUrl:"https://tuskegeetigers.com",recruitingEmail:"athletics@tuskegee.edu",jobsUrl:"https://tuskegeetigers.com/staff-directory"},
  // D2 / NAIA / JUCO
  101:{applyUrl:"https://admissions.gvsu.edu",athleticsUrl:"https://athletics.gvsu.edu",recruitingEmail:"athletics@gvsu.edu",jobsUrl:"https://athletics.gvsu.edu/staff-directory"},
  102:{applyUrl:"https://www.angelo.edu/admissions",athleticsUrl:"https://ramsports.net",recruitingEmail:"athletics@angelo.edu",jobsUrl:"https://ramsports.net/staff-directory"},
  103:{applyUrl:"https://www.wtamu.edu/admissions",athleticsUrl:"https://wtamusports.com",recruitingEmail:"athletics@wtamu.edu",jobsUrl:"https://wtamusports.com/staff-directory"},
  104:{applyUrl:"https://admissions.valdosta.edu",athleticsUrl:"https://vstateblazers.com",recruitingEmail:"athletics@valdosta.edu",jobsUrl:"https://vstateblazers.com/staff-directory"},
  105:{applyUrl:"https://www.ferris.edu/admissions",athleticsUrl:"https://ferrisstatebulldogs.com",recruitingEmail:"athletics@ferris.edu",jobsUrl:"https://ferrisstatebulldogs.com/staff-directory"},
  106:{applyUrl:"https://www.morningside.edu/admissions",athleticsUrl:"https://morningstsidemustangs.com",recruitingEmail:"athletics@morningside.edu",jobsUrl:"https://morningsidemustangs.com/staff-directory"},
  107:{applyUrl:"https://www.lindsey.edu/admissions",athleticsUrl:"https://lindseywilson.com/sports",recruitingEmail:"athletics@lindsey.edu",jobsUrl:"https://lindseywilson.com/sports/staff"},
  108:{applyUrl:"https://www.tjc.edu/admissions",athleticsUrl:"https://tjcapaches.com",recruitingEmail:"athletics@tjc.edu",jobsUrl:"https://tjcapaches.com/staff-directory"},
  109:{applyUrl:"https://www.navarrocollege.edu/admissions",athleticsUrl:"https://navarrocollege.edu/athletics",recruitingEmail:"athletics@navarrocollege.edu",jobsUrl:"https://navarrocollege.edu/athletics/staff"},
  110:{applyUrl:"https://www.iowawestern.edu/admissions",athleticsUrl:"https://iowawesternreivers.com",recruitingEmail:"athletics@iowawestern.edu",jobsUrl:"https://iowawesternreivers.com/staff-directory"},
  111:{applyUrl:"https://www.hutchcc.edu/admissions",athleticsUrl:"https://hutchcc.edu/athletics",recruitingEmail:"athletics@hutchcc.edu",jobsUrl:"https://hutchcc.edu/athletics/staff"},
};
// ── Seed Data ──────────────────────────────────
const SEED_ATHLETES=[
  {id:1,role:"athlete",name:"Marcus Webb",sport:"Football",school:"Undrafted – C-USA",followers:4200,tier:"rookie",mrr:29,plan:"pro",highlightUrl:"",status:"active",joined:"2026-01-12",email:"marcus@email.com",phone:"",country:"United States",state:"Texas",city:"Houston",bio:"WR with speed and route-running. Looking for overseas opportunities.",coachSent:3,brandSent:5,videos:[],deals:[],passwordHash:"",privacy:{...DEF_A_PRIV},blockedIds:[],referralCode:genCode(),referredBy:null,profileViews:47,notifications:[],verified:false,pinnedStats:[],achievements:[],following:[],followers_list:[]},
  {id:2,role:"athlete",name:"Jaylen Cross",sport:"Basketball",school:"HBCU – MEAC",followers:11800,tier:"pro",mrr:79,plan:"pro",highlightUrl:"",status:"active",joined:"2026-01-20",email:"jaylen@email.com",phone:"",country:"United States",state:"Georgia",city:"Atlanta",bio:"PG 6'2\". HBCU standout targeting pro opportunities in Europe or Asia.",coachSent:8,brandSent:14,videos:[],deals:[],passwordHash:"",privacy:{...DEF_A_PRIV},blockedIds:[],referralCode:genCode(),referredBy:null,profileViews:132,notifications:[],verified:true,pinnedStats:[],achievements:[],following:[],followers_list:[]},
  {id:3,role:"athlete",name:"Deja Monroe",sport:"Track",school:"D2 – GLIAC",followers:2100,tier:"rookie",mrr:29,plan:"pro",highlightUrl:"",status:"active",joined:"2026-02-03",email:"deja@email.com",phone:"",country:"United States",state:"Michigan",city:"Detroit",bio:"Sprinter 100m/200m. NCAA D2 record holder.",coachSent:2,brandSent:3,videos:[],deals:[],passwordHash:"",privacy:{...DEF_A_PRIV},blockedIds:[],referralCode:genCode(),referredBy:null,profileViews:28,notifications:[],verified:false,pinnedStats:[],achievements:[],following:[],followers_list:[]},
...
// ═══════════════════════════════════════════════
function SignupModal({show,onClose,settings,onFreeSignup}){
  ...
  const descs={rookie:"School contacts, Euro teams, messaging, NIL basics",rising:"AI roadmap, content vault, brand deals, priority support",pro:"Full suite, overseas pitch, coaching hub, NIL tracker"};
  ...
  return React.createElement(Modal,{show,onClose,title:"JOIN ATHLETEVAULT",maxW:500},
    ...
    React.createElement("div",{style:{display:"flex",gap:6,marginBottom:14}},
      [{v:"free",l:"Free Recruiting Profile"},{v:"paid",l:"Pro — Full Access"}].map(({v,l})=>React.createElement("button",{key:v,onClick:()=>setPlanType(v),style:{flex:1,padding:"9px 12px",borderRadius:7,border:"1px solid "+(planType===v?(v==="paid"?C.gold:C.green):C.border),background:planType===v?(v==="paid"?C.goldGlow:C.green+"11"):"transparent",color:planType===v?(v==="paid"?C.gold:C.green):C.muted,fontWeight:700,cursor:"pointer",fontSize:12}},l))
    ),
    planType==="free"&&React.createElement("div",{style:{background:C.green+"11",border:`1px solid ${C.green}33`,borderRadius:8,padding:"10px 12px",marginBottom:12,fontSize:12,color:C.mutedHi,lineHeight:1.6}},
      React.createElement("strong",{style:{color:C.green}},"Free includes: "),
      "Public recruiting profile · Shareable link · Combine stats · School database · Coach network browsing. Upgrade anytime to unlock messaging, NIL tracker, Euro teams, AI tools & more."
    ),
    ...
    planType==="paid"&&role==="athlete"&&React.createElement("div",{style:{display:"flex",flexDirection:"column",gap:8,marginBottom:14}},
      ...
      ["rookie","rising","pro"].map(t=>React.createElement("div",{key:t,onClick:()=>setTier(t),style:{display:"flex",justifyContent:"space-between",alignItems:"center",padding:"12px 14px",borderRadius:8,border:"1px solid "+(tier===t?C.gold:C.border),background:tier===t?C.goldGlow:"transparent",cursor:"pointer"}},
    ...
    planType==="paid"&&role==="coach"&&React.createElement("div",{style:{padding:"12px 14px",borderRadius:8,border:"1px solid "+C.blue+"44",background:C.blue+"11",marginBottom:14}},
...
function OOverview({athletes,coaches,messages,settings,onPreview}){
  ...
  return <div>
    ...
    <Card style={{marginBottom:16,padding:"12px 16px",display:"flex",gap:10,alignItems:"center",flexWrap:"wrap"}}>
      <span style={{color:C.muted,fontSize:12,flex:1,fontFamily:"DM Mono,monospace"}}>👁️ PREVIEW SITE AS:</span>
      <Btn onClick={()=>onPreview("athlete")} variant="ghost" small>👤 Athlete View</Btn>
      <Btn onClick={()=>onPreview("coach")} variant="ghost" small>🏈 Coach View</Btn>
      <Btn onClick={()=>onPreview("free")} variant="ghost" small>🔒 Free User View</Btn>
    </Card>
      ...
      <table style={{width:"100%",borderCollapse:"collapse"}}>
        ...
        <tbody>{filtered.map(a=><tr key={a.id} style={{borderBottom:`1px solid ${C.border}`}}>
          ...
          <td style={{padding:"10px 14px"}}><div style={{display:"flex",gap:4,flexWrap:"wrap"}}>
            ...
            <Btn onClick={()=>{saveAthletes(prev=>prev.map(x=>String(x.id)===String(a.id)?{...x,plan:a.plan==="pro"?"free":"pro"}:x));addLog({action:"Plan toggle",detail:`${a.name} → ${a.plan==="pro"?"free":"pro"}`,level:"info"});}} variant={a.plan==="pro"?"ghost":"green"} small>{a.plan==="pro"?"PRO ✓":"⬆ Upgrade"}</Btn>
...
const A_NAV=[{id:"home",icon:"🏠",label:"My Vault"},{id:"messages",icon:"💬",label:"Messages",pro:true},{id:"notifications",icon:"🔔",label:"Notifications"},{id:"schools",icon:"🏫",label:"Schools"},{id:"euroteams",icon:"🌍",label:"Euro Teams",pro:true},{id:"content",icon:"🎬",label:"Content",pro:true},{id:"brands",icon:"🤝",label:"Brand Deals",pro:true},{id:"coaches",icon:"📡",label:"Coaches",pro:true},{id:"money",icon:"💰",label:"Monetize",pro:true},{id:"stats",icon:"📊",label:"My Stats"},{id:"niltracker",icon:"💸",label:"NIL Tracker",pro:true},{id:"nil",icon:"🎓",label:"NIL Academy",pro:true},{id:"coaching",icon:"🎬",label:"Coaching Hub",pro:true},{id:"profile",icon:"👤",label:"My Profile"},{id:"privacy",icon:"🔒",label:"Privacy"},{id:"referral",icon:"🎁",label:"Refer & Earn"},{id:"help",icon:"❓",label:"Help"}];
    ...
    {view==="search"&&<div style={{display:"grid",gridTemplateColumns:"1fr 380px",gap:18,alignItems:"start"}}>
      ...
      <div style={{position:"sticky",top:20}}>
        {sel?<Card glow color={divColor[sel.div]}><div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:12}}><div><div style={{fontSize:30,marginBottom:5}}>{sel.logo}</div><div style={{fontFamily:"'Barlow Condensed',sans-serif",fontSize:20,fontWeight:900,color:C.white,letterSpacing:1,lineHeight:1}}>{sel.name}</div><div style={{color:divColor[sel.div]||C.gold,fontWeight:700,fontSize:12,marginTop:4}}>{sel.nick} · {sel.div}</div></div><button onClick={()=>toggleSave(sel.id)} style={{background:"none",border:"none",fontSize:22,cursor:"pointer"}}>{saved.includes(sel.id)?"⭐":"☆"}</button></div>
          <div style={{display:"flex",gap:5,flexWrap:"wrap",marginBottom:12}}><Badge color={divColor[sel.div]||C.muted}>{sel.div}</Badge><Badge color={C.blue}>{sel.conf}</Badge>{sel.type==="HBCU"&&<Badge color={C.teal}>HBCU</Badge>}{sel.type==="JUCO"&&<Badge color={C.blue}>JUCO</Badge>}{sel.type==="Military"&&<Badge color={C.purple}>Military</Badge>}{sel.scholarships&&<Badge color={C.gold}>Scholarships</Badge>}</div>
          {sel.desc&&<div style={{background:C.card2,borderRadius:8,padding:"10px 13px",margin:"0 0 13px 0"}}><div style={{color:C.teal,fontSize:10,fontFamily:"DM Mono,monospace",letterSpacing:1,marginBottom:5}}>ABOUT THIS PROGRAM</div><p style={{color:C.white,fontSize:12,lineHeight:1.7,margin:0}}>{sel.desc}</p></div>}
          {[["📍","Location",sel.loc],["🎓","Acceptance",sel.accept],["💰","Tuition",sel.tuition],["👥","Enrollment",sel.enrollment?sel.enrollment.toLocaleString()+" students":null]].filter(([,k,v])=>v).map(([ic,k,v])=><div key={k} style={{display:"flex",justifyContent:"space-between",padding:"7px 0",borderBottom:`1px solid ${C.border}`,gap:8}}><span style={{color:C.muted,fontSize:12}}>{ic} {k}</span><span style={{color:C.white,fontSize:12,fontWeight:600,textAlign:"right"}}>{v}</span></div>)}
          {isFree?<div style={{background:C.card2,borderRadius:8,padding:"10px 14px",margin:"8px 0",display:"flex",alignItems:"center",gap:10}}><span style={{fontSize:18}}>🔒</span><div style={{flex:1}}><div style={{color:C.gold,fontSize:11,fontWeight:700,marginBottom:2}}>PRO — Contact Info</div><div style={{color:C.muted,fontSize:11}}>Recruiting email &amp; athletics portal</div></div><button onClick={onUpgrade} style={{background:C.goldGlow,border:`1px solid ${C.gold}`,borderRadius:6,padding:"5px 10px",color:C.gold,fontWeight:700,fontSize:11,cursor:"pointer",fontFamily:"'Rajdhani',sans-serif",letterSpacing:1}}>UPGRADE</button></div>:(()=>{const sc=SCHOOL_CONTACTS[sel.id]||(sel.site?{athleticsUrl:`https://${sel.site}`,applyUrl:`https://${sel.site}/admissions`,recruitingEmail:null}:{});return<div style={{display:"flex",flexDirection:"column",gap:0}}>
            {sc.recruitingEmail&&<div style={{display:"flex",justifyContent:"space-between",padding:"7px 0",borderBottom:`1px solid ${C.border}`,gap:8}}><span style={{color:C.muted,fontSize:12}}>📧 Recruiting</span><a href={`mailto:${sc.recruitingEmail}`} style={{color:C.teal,fontSize:11,fontWeight:600,fontFamily:"DM Mono,monospace"}}>{sc.recruitingEmail}</a></div>}
            {sc.athleticsUrl&&<div style={{display:"flex",justifyContent:"space-between",padding:"7px 0",borderBottom:`1px solid ${C.border}`,gap:8}}><span style={{color:C.muted,fontSize:12}}>🏟️ Athletics</span><a href={`https://${sc.athleticsUrl.replace(/^https?:\/\//,"")}`} target="_blank" rel="noreferrer" style={{color:C.blue,fontSize:11,fontWeight:600}}>{sc.athleticsUrl.replace(/^https?:\/\//,"")}</a></div>}
          </div>})()}
          ...
          {isFree?<div style={{background:C.card2,borderRadius:8,padding:"10px 14px",margin:"8px 0 10px",display:"flex",alignItems:"center",gap:10}}><span style={{fontSize:18}}>🔒</span><div style={{flex:1}}><div style={{color:C.gold,fontSize:11,fontWeight:700,marginBottom:2}}>PRO — Apply &amp; Outreach</div><div style={{color:C.muted,fontSize:11}}>Application links &amp; AI email generator</div></div><button onClick={onUpgrade} style={{background:C.goldGlow,border:`1px solid ${C.gold}`,borderRadius:6,padding:"5px 10px",color:C.gold,fontWeight:700,fontSize:11,cursor:"pointer",fontFamily:"'Rajdhani',sans-serif",letterSpacing:1}}>UPGRADE</button></div>:(()=>{const sc2=SCHOOL_CONTACTS[sel.id]||(sel.site?{applyUrl:`https://${sel.site}/admissions`,athleticsUrl:`https://${sel.site}`}:{});return<div style={{display:"flex",gap:8,marginBottom:10,flexWrap:"wrap"}}>
            {sc2.applyUrl&&<a href={sc2.applyUrl} target="_blank" rel="noreferrer" style={{flex:1,display:"block",background:C.green+"22",border:`1px solid ${C.green}44`,borderRadius:6,padding:"10px",textAlign:"center",color:C.green,fontWeight:700,fontSize:12,fontFamily:"'Rajdhani',sans-serif",letterSpacing:1,cursor:"pointer",textDecoration:"none"}}>🎓 APPLY NOW →</a>}
            {sc2.athleticsUrl&&<a href={sc2.athleticsUrl} target="_blank" rel="noreferrer" style={{flex:1,display:"block",background:C.blue+"11",border:`1px solid ${C.blue}33`,borderRadius:6,padding:"10px",textAlign:"center",color:C.blue,fontWeight:700,fontSize:12,fontFamily:"'Rajdhani',sans-serif",letterSpacing:1,cursor:"pointer",textDecoration:"none"}}>🏟️ ATHLETICS SITE</a>}
          </div>;})()}
...
function AProfile({athlete,saveAthletes}){
  const [f,setF]=useState({name:athlete.name,sport:athlete.sport,school:athlete.school,city:athlete.city||"",state:athlete.state||"",country:athlete.country||"United States",bio:athlete.bio||"",phone:athlete.phone||"",followers:String(athlete.followers||0),highlightUrl:athlete.highlightUrl||""});
  const [saved,setSaved]=useState(false);
...
const CRM_STAGES=["Prospect","Contacted","Offer Sent","Signed"];
const CRM_COLORS={"Prospect":C.mutedHi,"Contacted":C.blue,"Offer Sent":C.gold,"Signed":C.green};
function CoachAthletes({coach,athletes,coaches,saveCoaches,messages,saveMessages,settings}){
  const [search,setSearch]=useState("");const [sportF,setSportF]=useState("all");const [countryF,setCountryF]=useState("all");const [tierF,setTierF]=useState("all");const [verF,setVerF]=useState("all");const [portalF,setPortalF]=useState(false);const [sel,setSel]=useState(null);const [loading,setLoading]=useState(false);const [msg,setMsg]=useState("");const [shortlisted,setShortlisted]=useState([]);const [view,setView]=useState("search");const [crmNote,setCrmNote]=useState({});const [selCrm,setSelCrm]=useState(null);
  const prospects=coach.prospects||[];
  ...
  const portalAthletes=visible.filter(a=>a.inPortal);
  const listBase=portalF?portalAthletes:visible;
  const filtered=listBase.filter(a=>{
  ...
  }).sort((a,b)=>(b.inPortal?1:0)-(a.inPortal?1:0));
  ...
  function addToBoard(athlete,stage){const ex=prospects.find(p=>String(p.athleteId)===String(athlete.id));if(ex)return;saveCoaches(prev=>prev.map(c=>String(c.id)===String(coach.id)?{...c,prospects:[...(c.prospects||[]),{athleteId:athlete.id,stage:stage||"Prospect",notes:"",addedDate:new Date().toISOString().slice(0,10)}]}:c));}
  function updateStage(athleteId,stage){saveCoaches(prev=>prev.map(c=>String(c.id)===String(coach.id)?{...c,prospects:(c.prospects||[]).map(p=>String(p.athleteId)===String(athleteId)?{...p,stage}:p)}:c));}
  function updateNote(athleteId,notes){saveCoaches(prev=>prev.map(c=>String(c.id)===String(coach.id)?{...c,prospects:(c.prospects||[]).map(p=>String(p.athleteId)===String(athleteId)?{...p,notes}:p)}:c));}
  function removeFromBoard(athleteId){saveCoaches(prev=>prev.map(c=>String(c.id)===String(coach.id)?{...c,prospects:(c.prospects||[]).filter(p=>String(p.athleteId)!==String(athleteId))}:c));}
  const tierColor={rookie:C.mutedHi,rising:C.gold,pro:C.purple};
  const priv=sel?.privacy||DEF_A_PRIV;
  return <div>
    <Sec title="Find Athletes" sub="Search, recruit, manage your pipeline."/>
    <div style={{display:"flex",gap:8,marginBottom:16,flexWrap:"wrap"}}>{[["search","🔍 Search"],["shortlist",`⭐ Shortlist (${shortlisted.length})`],["board",`📋 Board (${prospects.length})`]].map(([t,l])=><Btn key={t} onClick={()=>setView(t)} variant={view===t?"gold":"ghost"} small>{l}</Btn>)}{view==="search"&&<Btn onClick={()=>setPortalF(p=>!p)} variant={portalF?"accent":"ghost"} small>{portalF?"🔄 Portal Athletes Only":"🔄 Show Portal Only"}</Btn>}</div>
    ...
    {view==="board"&&<div>
      <p style={{color:C.muted,fontSize:12,marginBottom:14,fontFamily:"DM Mono,monospace"}}>{prospects.length} prospects in pipeline</p>
      {prospects.length===0?<Card style={{textAlign:"center",padding:40}}><div style={{fontSize:36,marginBottom:10}}>📋</div><div style={{color:C.white,fontWeight:700}}>Board is empty</div><div style={{color:C.muted,fontSize:13,marginTop:6}}>Find athletes in Search, then click "Add to Board" to start tracking them.</div></Card>:
      <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(300px,1fr))",gap:14}}>{prospects.map(p=>{
        const a=athletes.find(x=>String(x.id)===String(p.athleteId));
        if(!a)return null;
        const isEditing=selCrm===String(p.athleteId);
        return <Card key={p.athleteId} glow={isEditing} color={CRM_COLORS[p.stage]}>
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:10}}>
            <div style={{display:"flex",gap:9,alignItems:"center"}}><Avatar name={a.name} size={32} color={C.blue} verified={a.verified}/><div><div style={{color:C.white,fontWeight:700,fontSize:13}}>{a.name}</div><div style={{color:C.blue,fontSize:11}}>{a.sport}</div></div></div>
            <button onClick={()=>removeFromBoard(p.athleteId)} style={{background:"none",border:"none",color:C.muted,cursor:"pointer",fontSize:14}}>✕</button>
          </div>
          <div style={{display:"flex",gap:5,flexWrap:"wrap",marginBottom:10}}>
            {CRM_STAGES.map(s=><button key={s} onClick={()=>updateStage(p.athleteId,s)} style={{padding:"4px 10px",borderRadius:6,border:`1px solid ${p.stage===s?CRM_COLORS[s]:C.border}`,background:p.stage===s?CRM_COLORS[s]+"22":"transparent",color:p.stage===s?CRM_COLORS[s]:C.muted,fontSize:11,fontWeight:700,cursor:"pointer"}}>{s}</button>)}
          </div>
          {isEditing?<div><textarea value={crmNote[p.athleteId]!==undefined?crmNote[p.athleteId]:p.notes} onChange={e=>setCrmNote(prev=>({...prev,[p.athleteId]:e.target.value}))} placeholder="Notes about this recruit…" style={{width:"100%",background:C.dark,border:`1px solid ${C.border}`,borderRadius:6,padding:"8px 10px",color:C.white,fontSize:12,fontFamily:"'Sora',sans-serif",resize:"vertical",minHeight:64,boxSizing:"border-box",outline:"none"}} onBlur={()=>{updateNote(p.athleteId,crmNote[p.athleteId]!==undefined?crmNote[p.athleteId]:p.notes);setSelCrm(null);}}/></div>:<div onClick={()=>setSelCrm(String(p.athleteId))} style={{color:p.notes?C.mutedHi:C.muted,fontSize:12,fontStyle:p.notes?"normal":"italic",cursor:"pointer",minHeight:32,padding:"4px 0",lineHeight:1.5}}>{p.notes||"Click to add notes…"}</div>}
          <div style={{display:"flex",gap:6,marginTop:10,flexWrap:"wrap"}}>
            {a.inPortal&&<Badge color={C.gold}>🔄 Portal</Badge>}
            <Badge color={CRM_COLORS[p.stage]||C.muted}>{p.stage}</Badge>
            <div style={{color:C.muted,fontSize:10,marginLeft:"auto",alignSelf:"center",fontFamily:"DM Mono,monospace"}}>Added {p.addedDate}</div>
          </div>
        </Card>;
      })}</div>}
    </div>}
    {view==="search"&&<div>
      ...
      <p style={{color:C.muted,fontSize:12,marginBottom:12,fontFamily:"DM Mono,monospace"}}>{filtered.length} athletes found{portalF&&<span style={{color:C.gold}}> · 🔄 Transfer Portal Only</span>}{filtered.filter(a=>a.inPortal).length>0&&!portalF&&<span style={{color:C.gold}}> · {filtered.filter(a=>a.inPortal).length} in portal</span>}</p>
      <div style={{display:"grid",gridTemplateColumns:"1fr 380px",gap:18,alignItems:"start"}}>
        <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(210px,1fr))",gap:12}}>
          {filtered.map(a=><Card key={a.id} glow={sel?.id===a.id} onClick={()=>{setSel(a);setMsg("");}} style={{cursor:"pointer",borderColor:a.inPortal?C.gold:undefined}}>
            ...
            <div style={{display:"flex",gap:5,flexWrap:"wrap"}}><Badge color={tierColor[a.tier]}>{a.tier}</Badge>{a.inPortal&&<Badge color={C.gold}>🔄 Portal</Badge>}{priv.showFollowers!==false&&<Badge color={C.mutedHi}>{fmt(a.followers)} followers</Badge>}</div>
        ...
        <div style={{position:"sticky",top:20}}>{sel?<Card glow>
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:13}}>
            <div style={{display:"flex",gap:11,alignItems:"center"}}><Avatar name={sel.name} size={44} color={C.blue} verified={sel.verified}/><div><div style={{color:C.white,fontWeight:700,fontSize:16,display:"flex",alignItems:"center",gap:5}}>{sel.name}{sel.verified&&<Badge color={C.blue}>Verified</Badge>}{sel.inPortal&&<Badge color={C.gold}>🔄 Portal</Badge>}</div><div style={{color:C.blue,fontSize:13}}>{sel.sport}</div></div></div>
          ...
          <div style={{display:"flex",gap:8,marginBottom:8,flexWrap:"wrap"}}>
            <Btn onClick={()=>genOutreach(sel)} loading={loading} full>⚡ Generate Outreach</Btn>
            {!prospects.find(p=>String(p.athleteId)===String(sel.id))&&<Btn onClick={()=>addToBoard(sel,"Prospect")} variant="ghost" small>📋 Add to Board</Btn>}
            {prospects.find(p=>String(p.athleteId)===String(sel.id))&&<Badge color={CRM_COLORS[prospects.find(p=>String(p.athleteId)===String(sel.id))?.stage]||C.muted}>{prospects.find(p=>String(p.athleteId)===String(sel.id))?.stage}</Badge>}
          </div>
          {msg&&<><Btn onClick={()=>startMsg(sel)} variant="green" full style={{marginBottom:8}}>💬 Send via Messages</Btn><AIOut loading={loading} output={msg} label="OUTREACH EMAIL"/></>}
    ...
    <div style={{display:"grid",gridTemplateColumns:"1fr 380px",gap:18,alignItems:"start"}}>
      ...
      <div style={{position:"sticky",top:20}}>
        {sel?<Card glow><div style={{fontSize:28,marginBottom:7}}>{sel.logo}</div><div style={{fontFamily:"'Barlow Condensed',sans-serif",fontSize:19,fontWeight:900,color:C.white,marginBottom:3}}>{sel.name}</div><div style={{color:divColor[sel.div]||C.gold,fontWeight:700,fontSize:12,marginBottom:10}}>{sel.nick} · {sel.div} · {sel.conf}</div>
          {[["Location",sel.loc],["Acceptance",sel.accept],["Tuition",sel.tuition]].map(([k,v])=>v?<div key={k} style={{display:"flex",justifyContent:"space-between",padding:"7px 0",borderBottom:`1px solid ${C.border}`}}><span style={{color:C.muted,fontSize:12}}>{k}</span><span style={{color:C.white,fontSize:12,fontWeight:600}}>{v}</span></div>:null)}
          {(()=>{const sc=SCHOOL_CONTACTS[sel.id]||{};return sc.recruitingEmail?<div style={{display:"flex",justifyContent:"space-between",padding:"7px 0",borderBottom:`1px solid ${C.border}`}}><span style={{color:C.muted,fontSize:12}}>📧 Athletics</span><a href={`mailto:${sc.recruitingEmail}`} style={{color:C.teal,fontSize:11,fontFamily:"DM Mono,monospace",fontWeight:600}}>{sc.recruitingEmail}</a></div>:null;})()}
          ...
          {sel.openings&&sel.openings[coach?.sport]&&<div style={{background:C.green+"11",border:`1px solid ${C.green}33`,borderRadius:8,padding:"9px 12px",marginBottom:10}}><div style={{color:C.green,fontSize:10,fontFamily:"DM Mono,monospace",marginBottom:3}}>OPEN POSITIONS — {coach?.sport?.toUpperCase()}</div><div style={{color:C.white,fontSize:13,fontWeight:600}}>{sel.openings[coach?.sport]}</div></div>}
          <div style={{display:"flex",gap:8,marginBottom:10,flexWrap:"wrap"}}>
            {SCHOOL_CONTACTS[sel.id]?.jobsUrl&&<a href={SCHOOL_CONTACTS[sel.id].jobsUrl} target="_blank" rel="noreferrer" style={{flex:1,display:"block",background:C.gold+"22",border:`1px solid ${C.gold}44`,borderRadius:6,padding:"10px",textAlign:"center",color:C.gold,fontWeight:700,fontSize:12,fontFamily:"'Rajdhani',sans-serif",letterSpacing:1,textDecoration:"none"}}>💼 VIEW OPEN JOBS →</a>}
            <a href="https://www.higheredjobs.com/search/athletic_detail.cfm" target="_blank" rel="noreferrer" style={{flex:1,display:"block",background:C.blue+"11",border:`1px solid ${C.blue}33`,borderRadius:6,padding:"10px",textAlign:"center",color:C.blue,fontWeight:700,fontSize:12,fontFamily:"'Rajdhani',sans-serif",letterSpacing:1,textDecoration:"none"}}>🔍 HIGHEREDJOBS</a>
          </div>
          <Btn onClick={()=>genApp(sel)} loading={loading} full style={{marginTop:4}}>⚡ Generate Application Email</Btn>
...
function MarketingPage({onEnter,settings}){
  ...
  return <div style={{minHeight:"100vh",background:bg,fontFamily:"'Sora',sans-serif",overflowX:"hidden",position:"relative"}}>
    ...
    <div style={{padding:"80px 40px",background:"rgba(3,6,16,.95)",position:"relative",zIndex:2}}>
      <div style={{textAlign:"center",marginBottom:36}}>
        <div style={{fontFamily:"DM Mono,monospace",fontSize:9,letterSpacing:3,color:acc,marginBottom:10,textTransform:"uppercase"}}>// WHY SWITCH</div>
        <div style={{fontFamily:"'Orbitron',sans-serif",fontSize:"clamp(22px,3.5vw,40px)",lineHeight:1,color:wh}}>ONE PLATFORM BEATS <span style={{color:acc}}>ALL OF THEM.</span></div>
        <p style={{color:"rgba(224,244,255,.35)",fontSize:13,marginTop:10,fontFamily:"DM Mono,monospace"}}>vs. NCSA · EUROPLAYERS · POSTGAME · INFLICR · 247SPORTS</p>
      </div>
      <div style={{overflowX:"auto",maxWidth:900,margin:"0 auto"}}>
        <table style={{width:"100%",borderCollapse:"collapse",fontFamily:"'Sora',sans-serif",fontSize:13}}>
          <thead>
            <tr>
              {["FEATURE","NCSA","EUROPLAYERS","POSTGAME","247SPORTS","ATHLETEVAULT"].map((h,i)=><th key={i} style={{padding:"12px 10px",borderBottom:"2px solid "+(i===5?acc:border),color:i===5?acc:muted,fontFamily:"DM Mono,monospace",fontSize:9,letterSpacing:1.5,textAlign:i===0?"left":"center",whiteSpace:"nowrap"}}>{h}</th>)}
            </tr>
          </thead>
          <tbody>
            {[
              ["AI-written pitches & emails","✗","✗","✗","✗","✓"],
              ["European pro team database","✗","Partial","✗","✗","✓"],
              ["NIL education & deals","✗","✗","Partial","Partial","✓"],
              ["College school search","✓","✗","✗","Partial","✓"],
              ["Coach marketplace","✗","✗","✗","✗","✓"],
              ["Direct messaging","✗","✗","Partial","✗","✓"],
              ["Monthly price","$70–200","Free","$50+","Enterprise","$29–79"],
              ["Built by an athlete","✗","✗","✗","✗","✓"],
            ].map(([feat,...vals],ri)=><tr key={ri} style={{background:ri%2===0?"rgba(6,13,26,.6)":"transparent"}}>
              <td style={{padding:"11px 10px",color:wh,fontSize:12,fontWeight:600}}>{feat}</td>
              {vals.map((v,ci)=>{const isAV=ci===4;const isGood=v==="✓"||v.startsWith("$29");const isBad=v==="✗";return<td key={ci} style={{padding:"11px 10px",textAlign:"center",color:isAV?(isGood?acc:wh):isBad?"rgba(224,244,255,.2)":isGood?"rgba(224,244,255,.6)":"rgba(224,244,255,.45)",fontWeight:isAV?700:400,fontSize:isAV?14:12,fontFamily:isAV?"'Rajdhani',sans-serif":"inherit"}}>{v}</td>;})}
            </tr>)}
          </tbody>
        </table>
      </div>
...
// ── PaywallGate ─────────────────────────────────────
function PaywallGate({feature,onUpgrade}){
  return <div style={{minHeight:"60vh",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:40,textAlign:"center"}}>
    <div style={{fontSize:56,marginBottom:16}}>🔒</div>
    <div style={{fontFamily:"'Barlow Condensed',sans-serif",fontSize:32,fontWeight:900,color:C.white,letterSpacing:2,marginBottom:8}}>PRO FEATURE</div>
    <p style={{color:C.mutedHi,fontSize:14,lineHeight:1.7,maxWidth:400,marginBottom:24}}><strong style={{color:C.gold}}>{feature}</strong> is available on the Pro plan. Upgrade to unlock messaging, NIL tracking, Euro teams, brand deals, AI tools, and your full recruiting toolkit.</p>
    <div style={{display:"flex",gap:12,flexWrap:"wrap",justifyContent:"center",marginBottom:20}}>
      {[["🎯","School Contacts"],["💬","Coach Messaging"],["🌍","Euro Teams"],["💸","NIL Tracker"],["🤝","Brand Deals"],["⚡","AI Outreach"],["🎬","Content Tools"],["💰","Monetize"]].map(([icon,f])=><div key={f} style={{background:C.card,border:`1px solid ${C.border}`,borderRadius:8,padding:"8px 14px",color:C.muted,fontSize:12,display:"flex",gap:6,alignItems:"center"}}><span>{icon}</span>{f}</div>)}
    </div>
    <Btn onClick={onUpgrade} variant="gold" style={{padding:"14px 36px",fontSize:15}}>Upgrade to Pro →</Btn>
    <p style={{color:C.muted,fontSize:11,marginTop:12,fontFamily:"DM Mono,monospace"}}>STARTING AT $29/MO · CANCEL ANYTIME</p>
  </div>;
}

// ── OMyAccount ───────────────────────────────────────
function OMyAccount({athletes,saveAthletes,coaches,saveCoaches,settings,onSwitchToAthlete}){
  const existing=athletes.find(a=>a.ownerAccount);
  const [f,setF]=useState({name:existing?.name||"",sport:existing?.sport||"Football",school:existing?.school||"",city:existing?.city||"",state:existing?.state||"",country:existing?.country||"United States",bio:existing?.bio||"",email:existing?.email||"",password:"",highlightUrl:existing?.highlightUrl||""});
  const [saved,setSaved]=useState(false);
  function saveAccount(){
    if(!f.name||!f.email)return;
    if(existing){
      saveAthletes(prev=>prev.map(a=>a.ownerAccount?{...a,...f,followers:a.followers||0,passwordHash:f.password?hashPass(f.password):a.passwordHash}:a));
    } else {
      const na={id:Date.now(),role:"athlete",ownerAccount:true,name:f.name,sport:f.sport,school:f.school||"AthleteVault Owner",city:f.city,state:f.state,country:f.country,bio:f.bio,email:f.email,passwordHash:f.password?hashPass(f.password):"",plan:"pro",tier:"pro",mrr:0,status:"active",joined:new Date().toISOString().slice(0,10),followers:0,coachSent:0,brandSent:0,videos:[],deals:[],privacy:{...DEF_A_PRIV},blockedIds:[],referralCode:genCode(),referredBy:null,profileViews:0,notifications:[],verified:true,pinnedStats:[],achievements:[],following:[],followers_list:[],highlightUrl:f.highlightUrl||""};
      saveAthletes(prev=>[...prev,na]);
    }
    setSaved(true);setTimeout(()=>setSaved(false),2000);
  }
  return <div>
    <Sec title="My Athlete Profile" sub="Play your sport. Own your brand. Log in as yourself."/>
    {existing&&<Card glow color={C.gold} style={{marginBottom:16,padding:"12px 16px",display:"flex",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:10}}>
      <div><div style={{color:C.gold,fontWeight:700,fontSize:13}}>ACCOUNT ACTIVE — {existing.name}</div><div style={{color:C.mutedHi,fontSize:12}}>Login: {existing.email} · Plan: PRO ✓</div></div>
      <Btn onClick={()=>onSwitchToAthlete(existing)} variant="gold" small>Switch to My Profile →</Btn>
    </Card>}
    <Card>
      <div style={{color:C.muted,fontSize:10,fontFamily:"DM Mono,monospace",letterSpacing:1,marginBottom:14}}>YOUR ATHLETE ACCOUNT</div>
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:12,marginBottom:12}}>
        <Inp label="FULL NAME" value={f.name} onChange={v=>setF(p=>({...p,name:v}))} placeholder="Dennis Barnes"/>
        <Inp label="SPORT" value={f.sport} onChange={v=>setF(p=>({...p,sport:v}))} placeholder="Football"/>
        <Inp label="SCHOOL / LEAGUE" value={f.school} onChange={v=>setF(p=>({...p,school:v}))} placeholder="UTEP / GFL Berlin"/>
        <Inp label="EMAIL" value={f.email} onChange={v=>setF(p=>({...p,email:v}))} placeholder="you@email.com"/>
        <Inp label="PASSWORD" value={f.password} onChange={v=>setF(p=>({...p,password:v}))} type="password" placeholder="Set/change password"/>
        <Inp label="HIGHLIGHT REEL URL" value={f.highlightUrl} onChange={v=>setF(p=>({...p,highlightUrl:v}))} placeholder="YouTube or Hudl link"/>
        <Inp label="CITY" value={f.city} onChange={v=>setF(p=>({...p,city:v}))} placeholder="El Paso"/>
        <Inp label="STATE" value={f.state} onChange={v=>setF(p=>({...p,state:v}))} placeholder="Texas"/>
      </div>
      <Inp label="BIO" value={f.bio} onChange={v=>setF(p=>({...p,bio:v}))} rows={3} placeholder="Your story — position, accomplishments, goals..."/>
      <div style={{marginTop:12,display:"flex",gap:10,flexWrap:"wrap"}}>
        <Btn onClick={saveAccount} disabled={!f.name||!f.email}>{saved?"✓ Saved!":existing?"Update Profile":"Create My Athlete Account"}</Btn>
        {existing&&<Btn onClick={()=>onSwitchToAthlete(existing)} variant="gold">Switch to Athlete View →</Btn>}
      </div>
      {!existing&&<p style={{color:C.muted,fontSize:12,marginTop:10,lineHeight:1.6}}>After creating your account you can log in with this email/password as an athlete, or use the "Switch to My Profile" button above to jump directly. Your owner dashboard is always accessible by logging out and back in as the owner.</p>}
    </Card>
  </div>;
}
...
export default function App(){
  ...
  function createFreeAccount({name,email,password,sport,role:r}){
    if(r==="coach"){
      ...
      const na={id:Date.now(),role:"athlete",name,email,sport:sport||"Football",tier:"rookie",plan:"free",mrr:0,status:"active",joined:new Date().toISOString().slice(0,10),followers:0,coachSent:0,brandSent:0,videos:[],deals:[],privacy:{...DEF_A_PRIV},blockedIds:[],referralCode:genCode(),referredBy:null,profileViews:0,notifications:[],verified:false,passwordHash:hashPass(password),pinnedStats:[],achievements:[],following:[],followers_list:[],highlightUrl:""};
      saveAthletes(prev=>[...prev,na]);
  ...
  function handlePreview(type){
    if(type==="athlete"){const u=athletes.find(a=>a.status==="active")||athletes[0];setPreviewAs({role:"athlete",user:u});}
    else if(type==="coach"){const c=coaches.find(c=>c.status==="active")||coaches[0];setPreviewAs({role:"coach",user:c});}
    else if(type==="free"){const u=athletes.find(a=>a.status==="active")||athletes[0];setPreviewAs({role:"athlete",user:{...u,plan:"free"}});}
    setTab("home");
  }
  ...
  function renderTab(){
    if(role==="owner"){
      ...
      if(tab==="overview")return <OOverview athletes={athletes} coaches={coaches} messages={messages} settings={settings} onPreview={handlePreview}/>;
      ...
      if(tab==="myaccount")return <OMyAccount athletes={athletes} saveAthletes={saveAthletes} coaches={coaches} saveCoaches={saveCoaches} settings={settings} onSwitchToAthlete={a=>{setSession({role:"athlete",user:a});setPreviewAs(null);setTab("home");}}/>;
    }
    const isPro=!isFreeUser;
    function gate(feature,el){return isFreeUser?<PaywallGate feature={feature} onUpgrade={upgrade}/>:el;}
    if(role==="athlete"&&liveUser){
      ...
      if(tab==="messages")return gate("Direct Messaging",<Messaging me={liveUser} athletes={athletes} coaches={coaches} saveAthletes={saveAthletes} saveCoaches={saveCoaches} messages={messages} saveMessages={saveMessages} settings={settings}/>);
      ...
      if(tab==="niltracker")return gate("NIL Deal Tracker",<ANILTracker athlete={liveUser} saveAthletes={saveAthletes} athletes={athletes}/>);
      if(tab==="nil")return gate("NIL Academy",<ANIL/>);
      if(tab==="coaching")return gate("Coaching Hub",<CoachingHub athlete={liveUser} coaches={coaches} athletes={athletes} messages={messages} saveMessages={saveMessages} saveAthletes={saveAthletes}/>);
  ...
  return <div style={{display:"flex",fontFamily:"'Sora',sans-serif",background:C.black,minHeight:"100vh",flexDirection:"column"}}>
    {previewAs&&<div style={{background:C.gold,color:C.black,padding:"9px 20px",display:"flex",justifyContent:"space-between",alignItems:"center",fontFamily:"'Barlow Condensed',sans-serif",fontSize:13,fontWeight:900,letterSpacing:1,flexShrink:0,zIndex:100}}>
      <span>👁️ PREVIEW MODE — {role.toUpperCase()} VIEW {previewAs.user?.plan==="free"?"(FREE PLAN)":""}: {previewAs.user?.name||"User"}</span>
